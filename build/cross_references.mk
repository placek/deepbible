...
$(cross_refs_sql): $(cross_refs_txt)
	...
	@echo "  )" >> "$@"
	@echo ");" >> "$@"
	@echo "CREATE TABLE _cross_references (book_number INTEGER, chapter INTEGER, verse INTEGER, b1 INTEGER, c1 INTEGER, v1 INTEGER, b2 INTEGER, c2 INTEGER, v2 INTEGER, rate INTEGER);" >> "$@"
	@echo "COMMIT;" >> "$@"
	@echo "BEGIN;" >> "$@"
	@echo "ATTACH DATABASE '$(books_db)' AS booksdb;" >> "$@"
	@echo "INSERT INTO _cross_references" >> "$@"
	@echo "SELECT" >> "$@"
