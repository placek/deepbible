...
$(cross_refs_sql): $(cross_refs_txt)
	...
	@echo "SELECT" >> "$@"
	@echo "  bf.book_number AS book_number," >> "$@"
	...
	@echo "LEFT JOIN booksdb.books bf  ON lower(bf.short_name)  = lower(cs.b)" >> "$@"
	@echo "LEFT JOIN booksdb.books bt1 ON lower(bt1.short_name) = lower(cs.b1)" >> "$@"
	@echo "LEFT JOIN booksdb.books bt2 ON lower(bt2.short_name) = lower(cs.b2);" >> "$@"
	@echo "COMMIT;" >> "$@"
