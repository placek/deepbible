...
re-fetch: failed.txt
	@$(call say,re-fetching failed zip files...)
	@while read file; do \
	  rm -rf "$$file"; \
	  $(MAKE) "$$file"; \
	done < $<
...
$(grouped_dir)/%: $(grouped_dir)
	@$(call say,grouping SQLite3 DBs for language: $* in $<)
