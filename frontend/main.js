...
var slugify = (text6) => {
  return text6.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
};
var downloadMarkdownFile = (filename) => (content3) => () => {
  ...
  const blob = new Blob([text6], { type: "text/markdown;charset=utf-8" });
  const url = URL.createObjectURL(blob);
  const link3 = document.createElement("a");
  link3.href = url;
  link3.download = safeName;
...
// output/App.State/index.js
var PericopeItem = /* @__PURE__ */ function() {
  function PericopeItem2(value0) {
    this.value0 = value0;
  }
  ;
  PericopeItem2.create = function(value0) {
    return new PericopeItem2(value0);
  };
  return PericopeItem2;
}();
var NoteItem = /* @__PURE__ */ function() {
  function NoteItem2(value0) {
    this.value0 = value0;
  }
  ;
  NoteItem2.create = function(value0) {
    return new NoteItem2(value0);
  };
  return NoteItem2;
}();
...
var renderItem = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at App.Markdown (line 27, column 14 - line 29, column 51): " + [v.constructor.name]);
};
...
var randomBytes = (bytes) => {
  ...
  if (typeof crypto !== "undefined" && crypto.getRandomValues) {
    ...
    for (let i2 = 0; i2 < buffer.length; i2++) {
      buffer[i2] = Math.floor(Math.random() * 256);
    }
  }
  return buffer;
};
...
var size3 = /* @__PURE__ */ coerce3(size2);
...
var lastIndexOf2 = function(p2) {
  return function(s) {
    return map9(function(i2) {
      return length4(take3(i2)(s));
    })(lastIndexOf(p2)(s));
  };
};
  ...
  return function(obj) {
    return function(str) {
      var decode = function(json3) {
        ...
        ;
        return map10(Just.create)(lmap2(AtKey.create(str))(decoder(json3)));
      };
...
var sanitizeSeed = function(v) {
  if (v.kind === "pericope") {
    var $29 = v.address === "" && v.source === "";
    if ($29) {
      return Nothing.value;
    }
    ;
...
var sanitizeSeeds = /* @__PURE__ */ mapMaybe(sanitizeSeed);
var itemsToSeeds = function(ps) {
  var pericopeSeed2 = function(p2) {
    return {
      kind: "pericope",
      address: p2.address,
      source: p2.source,
  ...
  return mapFlipped3(ps)(function(v) {
    if (v instanceof PericopeItem) {
      return pericopeSeed2(v.value0);
    }
    ;
    if (v instanceof NoteItem) {
...
var encodeItemSeed = {
  encodeJson: function(v) {
    return extend4(assoc3("kind")(v.kind))(extend4(assoc3("address")(v.address))(extend4(assoc3("source")(v.source))(extend4(assoc3("content")(v.content))(jsonEmptyObject))));
  }
};
...
var decodeItemSeed = {
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField3(obj)("kind"))(function(kind2) {
        return bind2(map12(fromMaybe(""))(getFieldOptional$prime3(obj)("address")))(function(address2) {
          return bind2(map12(fromMaybe(""))(getFieldOptional$prime3(obj)("source")))(function(source2) {
            return bind2(map12(fromMaybe(""))(getFieldOptional$prime3(obj)("content")))(function(content3) {
              return pure3({
                kind: kind2,
                address: address2,
                source: source2,
...
var decodeArray3 = /* @__PURE__ */ decodeArray2(decodeItemSeed);
var getField1 = /* @__PURE__ */ getField2(decodeArray3);
...
var functorExceptT = function(dictFunctor) {
  ...
  return {
    map: function(f) {
      return mapExceptT(map112(map13(f)));
    }
  };
};
...
var selectElement = function(query3) {
  return bind3(liftEffect3(bindFlipped5(composeKleisliFlipped3(function() {
...
var handler$prime = function(et) {
  return function(f) {
    return handler(et)(function(ev) {
      return map22(Action.create)(f(ev));
    });
  };
};
...
var addForeignPropHandler = function(key2) {
  return function(prop5) {
    return function(reader) {
      return function(f) {
        var go2 = function(a2) {
          return composeKleisliFlipped4(reader)(readProp2(prop5))(unsafeToForeign(a2));
        };
...
var evalQ = function(render4) {
  return function(ref2) {
    return function(q2) {
      return bind12(liftEffect4(read(ref2)))(function(v) {
        return evalM(render4)(ref2)(v["component"]["eval"](new Query(map23(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
      });
    };
  };
};
          ...
          if (v1 instanceof Subscribe) {
            return bind12(fresh(SubscriptionId)(ref2))(function(sid) {
              return bind12(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                ...
                return bind12(liftEffect4(read(ref2)))(function(v2) {
                  return discard1(liftEffect4(modify_(map24(insert8(sid)(finalize)))(v2.subscriptions)))(function() {
  ...
  return function(req) {
    ...
    var extractContent = function(v2) {
      ...
      if (v2 instanceof FormURLEncoded) {
        return note("Body contains values that cannot be encoded as application/x-www-form-urlencoded")(map29(unsafeToForeign)(encode(v2.value0)));
      }
      ;
    ...
    var headers = function(reqContent) {
      return addHeader(map29(ContentType.create)(bindFlipped9(toMediaType)(reqContent)))(addHeader(map29(Accept.create)(toMediaType2(req.responseFormat)))(req.headers));
    };
...
// output/Domain.Bible.Types/index.js
...
var getFieldOptional$prime4 = /* @__PURE__ */ getFieldOptional$prime2(decodeJsonString);
var getFieldOptional$prime1 = /* @__PURE__ */ getFieldOptional$prime2(/* @__PURE__ */ decodeArray2(decodeJsonString));
var decodeVerseSearchResult = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField4(obj)("address"))(function(address2) {
        return bind6(getField4(obj)("source"))(function(source2) {
          return bind6(getField4(obj)("text"))(function(text6) {
            return pure14({
              address: address2,
              source: source2,
              text: text6
...
var decodeVerse = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField12(obj)("book_number"))(function(book_number) {
        return bind6(getField12(obj)("chapter"))(function(chapter) {
          return bind6(getField12(obj)("verse"))(function(verse) {
            return bind6(getField4(obj)("language"))(function(language2) {
              return bind6(getField4(obj)("source"))(function(source2) {
                return bind6(getField4(obj)("address"))(function(address2) {
                  return bind6(getField4(obj)("text"))(function(text6) {
                    return bind6(getFieldOptional$prime4(obj)("verse_id"))(function(maybeVerseId) {
                      return bind6(getFieldOptional$prime4(obj)("id"))(function(maybeId) {
                        ...
                        var verse_id = function() {
                          ...
                          ;
                          throw new Error("Failed pattern match at Domain.Bible.Types (line 102, column 9 - line 104, column 50): " + [maybeVerseId.constructor.name]);
                        }();
                        return pure14({
                          book_number,
                          chapter,
...
var decodeStory = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField4(obj)("source"))(function(source2) {
        return bind6(getField4(obj)("book"))(function(book) {
          return bind6(getField4(obj)("title"))(function(title4) {
            return bind6(getField4(obj)("address"))(function(address2) {
              return bind6(getField12(obj)("a"))(function(a2) {
                return bind6(getField12(obj)("b"))(function(b2) {
                  return pure14({
                    source: source2,
                    book,
                    title: title4,
...
var decodeSourceInfo = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField4(obj)("name"))(function(name16) {
        return bind6(bind6(getFieldOptional$prime4(obj)("description_short"))(function(maybeDescription) {
          return pure14(fromMaybe("")(maybeDescription));
        }))(function(description_short) {
          return bind6(bind6(getFieldOptional$prime4(obj)("language"))(function(maybeLanguage) {
            return pure14(fromMaybe("unknown")(maybeLanguage));
          }))(function(language2) {
            return pure14({
              name: name16,
              description_short,
...
var decodeDictionaryEntry = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getFieldOptional$prime4(obj)("topic"))(function(topic) {
        return bind6(getFieldOptional$prime4(obj)("word"))(function(word) {
          return bind6(getFieldOptional$prime4(obj)("meaning"))(function(meaning) {
            return bind6(getFieldOptional$prime4(obj)("parse"))(function(parse7) {
              return bind6(getFieldOptional$prime1(obj)("forms"))(function(forms) {
                return pure14({
                  topic: fromMaybe("")(topic),
                  word: fromMaybe("")(word),
                  meaning: fromMaybe("")(meaning),
                  parse: fromMaybe("")(parse7),
...
var decodeCrossReference = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField4(obj)("address"))(function(address2) {
        return bind6(getField4(obj)("reference"))(function(reference) {
          return bind6(getField12(obj)("rate"))(function(rate) {
            return pure14({
              address: address2,
              reference,
              rate
...
var decodeCommentary = {
  decodeJson: function(j) {
    return bind6(decodeJson3(j))(function(obj) {
      return bind6(getField4(obj)("marker"))(function(marker) {
        return bind6(getField4(obj)("text"))(function(text6) {
          return pure14({
            marker,
            text: text6
...
var getField13 = /* @__PURE__ */ getField2(decodeJsonJson);
...
var decodeJson12 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeCommentary));
var decodeJson23 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeCrossReference));
var decodeJson32 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeStory));
var decodeJson42 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeSourceInfo));
var decodeJson5 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeDictionaryEntry));
var decodeJson6 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeVerse));
var assoc12 = /* @__PURE__ */ assoc2(encodeJsonJString);
var decodeJson7 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeVerseSearchResult));
  ...
  decodeJson: function(j) {
    return bind7(decodeJson4(j))(function(obj) {
      return bind7(getField5(obj)("id"))(function(id3) {
        return bind7(getField13(obj)("data"))(function(dataJson) {
          return pure15({
            id: id3,
            sheetData: dataJson
          });
...
var fetchCommentaries = function(verseId) {
  ...
  var payload = extend5(assoc4("p_verse_id")(id(verseId)))(jsonEmptyObject);
  return bind15(postgrestPost(url)(payload))(function(res) {
    if (res instanceof Left) {
      return pure16(new Left("HTTP error: " + printError(res.value0)));
    }
    ;
    if (res instanceof Right) {
      var v = decodeJson12(res.value0.body);
      if (v instanceof Left) {
        return pure16(new Left("Failed to fetch commentaries: " + verseId));
      }
      ;
      if (v instanceof Right) {
        return pure16(new Right(v.value0));
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 127, column 19 - line 129, column 54): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 125, column 3 - line 129, column 54): " + [res.constructor.name]);
  });
};
var fetchCrossReferences = function(address2) {
  return function(source2) {
    var url = baseUrl + "/rpc/fetch_cross_references_by_address";
    var payload = extend5(assoc4("p_address")(id(address2)))(extend5(assoc4("p_source")(id(source2)))(jsonEmptyObject));
    return bind15(postgrestPost(url)(payload))(function(res) {
      if (res instanceof Left) {
        return pure16(new Left("HTTP error: " + printError(res.value0)));
      }
      ;
      if (res instanceof Right) {
        var v = decodeJson23(res.value0.body);
        if (v instanceof Left) {
          return pure16(new Left("Failed to fetch cross references: " + address2));
        }
        ;
        if (v instanceof Right) {
          return pure16(new Right(v.value0));
        ...
        ;
        throw new Error("Failed pattern match at Infrastructure.Api (line 115, column 19 - line 117, column 38): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 113, column 3 - line 117, column 38): " + [res.constructor.name]);
    });
  };
};
var fetchRenderedStories = function(source2) {
  return function(address2) {
    ...
    var payload = extend5(assoc4("p_source")(id(source2)))(extend5(assoc4("p_address")(id(address2)))(jsonEmptyObject));
    return bind15(postgrestPost(url)(payload))(function(res) {
      if (res instanceof Left) {
        return pure16(new Left("HTTP error: " + printError(res.value0)));
      }
      ...
      if (res instanceof Right) {
        ...
        if (v instanceof Left) {
          return pure16(new Left("Failed to fetch stories: " + address2));
        }
        ;
        if (v instanceof Right) {
          return pure16(new Right(v.value0));
        ...
        ;
        throw new Error("Failed pattern match at Infrastructure.Api (line 139, column 19 - line 141, column 44): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 137, column 3 - line 141, column 44): " + [res.constructor.name]);
    });
  };
};
var fetchSheet = function(sheetId) {
  var url = baseUrl + "/rpc/fetch_sheet";
  var payload = extend5(assoc4("p_id")(id(sheetId)))(jsonEmptyObject);
  return bind15(postgrestPost(url)(payload))(function(res) {
    if (res instanceof Left) {
      return pure16(new Left("HTTP error: " + printError(res.value0)));
    }
    ;
    if (res instanceof Right) {
      var v = decodeJson8(res.value0.body);
      if (v instanceof Left) {
        return pure16(new Left("Failed to fetch sheet"));
      }
      ;
      if (v instanceof Right) {
        var v1 = head(v.value0);
        if (v1 instanceof Nothing) {
          return pure16(new Right(Nothing.value));
        }
        ;
        if (v1 instanceof Just) {
          return pure16(new Right(new Just(v1.value0.sheetData)));
        }
        ;
        throw new Error("Failed pattern match at Infrastructure.Api (line 68, column 23 - line 70, column 66): " + [v1.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 66, column 19 - line 70, column 66): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 64, column 3 - line 70, column 66): " + [res.constructor.name]);
  });
};
var fetchSources = /* @__PURE__ */ function() {
  var url = baseUrl + "/rpc/_all_sources?select=name,description_short,language";
  return bind15(postgrestPost(url)(jsonEmptyObject))(function(res) {
    if (res instanceof Left) {
      return pure16(new Left("HTTP error: " + printError(res.value0)));
    }
    ;
    if (res instanceof Right) {
      var v = decodeJson42(res.value0.body);
      if (v instanceof Left) {
        return pure16(new Left("Failed to fetch sources"));
      }
      ;
      if (v instanceof Right) {
        return pure16(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 103, column 19 - line 105, column 44): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 101, column 3 - line 105, column 44): " + [res.constructor.name]);
  });
}();
var fetchVerseDictionary = function(verseId) {
  ...
  return bind15(postgrestPost(url)(payload))(function(res) {
    ...
    ;
    if (res instanceof Right) {
      var v = decodeJson5(res.value0.body);
      if (v instanceof Left) {
        return pure16(new Left("Failed to fetch verse dictionary: " + verseId));
      }
      ;
      if (v instanceof Right) {
        return pure16(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 151, column 19 - line 153, column 44): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 149, column 3 - line 153, column 44): " + [res.constructor.name]);
  });
};
  ...
  return function(source2) {
    ...
    return bind15(postgrestPost(url)(payload))(function(res) {
      ...
      if (res instanceof Right) {
        ...
        if (v instanceof Left) {
          return pure16(new Left("Failed to fetch verses: " + address2));
        }
        ;
        if (v instanceof Right) {
          return pure16(new Right(v.value0));
...
var searchVerses = function(query3) {
  ...
  var payload = extend5(assoc12("search_phrase")(query3))(jsonEmptyObject);
  return bind15(postgrestPost(url)(payload))(function(res) {
    if (res instanceof Left) {
      return pure16(new Left("HTTP error: " + printError(res.value0)));
    }
    ;
    if (res instanceof Right) {
      var v = decodeJson7(res.value0.body);
      if (v instanceof Left) {
        return pure16(new Left("Failed to search verses"));
      }
      ;
      if (v instanceof Right) {
        return pure16(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 163, column 19 - line 165, column 42): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 161, column 3 - line 165, column 42): " + [res.constructor.name]);
  });
};
var upsertSheet = function(sheetId) {
  return function(dataJson) {
    var url = baseUrl + "/rpc/upsert_sheet";
    var payload = extend5(assoc4("p_id")(id(sheetId)))(extend5(assoc4("p_data")(dataJson))(jsonEmptyObject));
    return bind15(postgrestPost(url)(payload))(function(res) {
      if (res instanceof Left) {
        return pure16(new Left("HTTP error: " + printError(res.value0)));
      }
      ;
      if (res instanceof Right) {
        return pure16(new Right(unit));
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 78, column 3 - line 80, column 33): " + [res.constructor.name]);
    });
  };
};

// output/Infrastructure.LocalStorage/foreign.js
var STORAGE_KEY = "deepbible:sheets";
var readMap = () => {
  try {
...
var DidDuplicate = /* @__PURE__ */ function() {
  ...
  ;
  DidDuplicate3.create = function(value0) {
    return new DidDuplicate3(value0);
  };
  return DidDuplicate3;
}();
var DidRemove = /* @__PURE__ */ function() {
  function DidRemove3(value0) {
    this.value0 = value0;
  }
  ;
  DidRemove3.create = function(value0) {
    return new DidRemove3(value0);
  };
  return DidRemove3;
}();
var DidStartDrag = /* @__PURE__ */ function() {
  function DidStartDrag3(value0) {
    this.value0 = value0;
  }
  ;
  DidStartDrag3.create = function(value0) {
    return new DidStartDrag3(value0);
  };
  return DidStartDrag3;
}();
var DidDragOver = /* @__PURE__ */ function() {
  function DidDragOver3(value0) {
    this.value0 = value0;
  }
  ;
  DidDragOver3.create = function(value0) {
    return new DidDragOver3(value0);
  };
  return DidDragOver3;
}();
var DidDragLeave = /* @__PURE__ */ function() {
  function DidDragLeave3(value0) {
    this.value0 = value0;
  }
  ;
  DidDragLeave3.create = function(value0) {
    return new DidDragLeave3(value0);
  };
  return DidDragLeave3;
}();
var DidReorder = /* @__PURE__ */ function() {
  function DidReorder3(value0) {
    this.value0 = value0;
  }
  ;
  DidReorder3.create = function(value0) {
    return new DidReorder3(value0);
  };
  return DidReorder3;
}();
var DidUpdate = /* @__PURE__ */ function() {
  function DidUpdate3(value0) {
    this.value0 = value0;
  }
  ;
  DidUpdate3.create = function(value0) {
    return new DidUpdate3(value0);
  };
  return DidUpdate3;
}();
...
var Duplicate = /* @__PURE__ */ function() {
  ...
  ;
  Duplicate3.value = new Duplicate3();
  return Duplicate3;
}();
...
var DragStart = /* @__PURE__ */ function() {
  function DragStart3(value0) {
    this.value0 = value0;
  }
  ;
  DragStart3.create = function(value0) {
    return new DragStart3(value0);
  };
  return DragStart3;
}();
var DragOver = /* @__PURE__ */ function() {
  function DragOver3(value0) {
    this.value0 = value0;
  }
  ;
  DragOver3.create = function(value0) {
    return new DragOver3(value0);
  };
  return DragOver3;
}();
var DragLeave = /* @__PURE__ */ function() {
  function DragLeave3(value0) {
    this.value0 = value0;
  }
  ;
  DragLeave3.create = function(value0) {
    return new DragLeave3(value0);
  };
  return DragLeave3;
}();
var Drop = /* @__PURE__ */ function() {
  function Drop3(value0) {
    this.value0 = value0;
  }
  ;
  Drop3.create = function(value0) {
    return new Drop3(value0);
  };
  return Drop3;
}();
...
var handle = function(dictMonadAff) {
  ...
  return function(v) {
    ...
    if (v instanceof Remove) {
      return bind8(get4)(function(st) {
        return raise(new DidRemove(st.note.id));
      });
    }
    ;
    if (v instanceof DragStart) {
      return discard12(liftEffect9(stopPropagation(toEvent(v.value0))))(function() {
        return bind8(get4)(function(st) {
          return raise(new DidStartDrag(st.note.id));
        });
      });
    }
    ;
    if (v instanceof DragOver) {
      return discard12(liftEffect9(function __do2() {
        ...
        return bind8(get4)(function(st) {
          return raise(new DidDragOver(st.note.id));
        });
      });
    }
    ;
    if (v instanceof DragLeave) {
      return bind8(get4)(function(st) {
        return raise(new DidDragLeave(st.note.id));
      });
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Note.Component (line 118, column 10 - line 168, column 32): " + [v.constructor.name]);
  };
};
...
var eq12 = /* @__PURE__ */ eq(/* @__PURE__ */ eqSet(eqString));
...
var SetData = /* @__PURE__ */ function() {
  ...
  ;
  SetData2.create = function(value0) {
    return function(value1) {
      return new SetData2(value0, value1);
    };
  };
  return SetData2;
}();
var Refresh = /* @__PURE__ */ function() {
  function Refresh2(value0) {
    this.value0 = value0;
  }
  ;
  Refresh2.create = function(value0) {
    return new Refresh2(value0);
  };
  return Refresh2;
}();
var CancelEditing = /* @__PURE__ */ function() {
  function CancelEditing2(value0) {
    this.value0 = value0;
  }
  ;
  CancelEditing2.create = function(value0) {
    return new CancelEditing2(value0);
  };
  return CancelEditing2;
}();
var DidDuplicate2 = /* @__PURE__ */ function() {
  function DidDuplicate3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidRemove2 = /* @__PURE__ */ function() {
  function DidRemove3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidStartDrag2 = /* @__PURE__ */ function() {
  function DidStartDrag3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidDragOver2 = /* @__PURE__ */ function() {
  function DidDragOver3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidDragLeave2 = /* @__PURE__ */ function() {
  function DidDragLeave3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidReorder2 = /* @__PURE__ */ function() {
  function DidReorder3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidUpdate2 = /* @__PURE__ */ function() {
  function DidUpdate3(value0) {
    this.value0 = value0;
  }
  ;
...
var DidLoadCrossReference = /* @__PURE__ */ function() {
  function DidLoadCrossReference2(value0) {
    this.value0 = value0;
  }
  ;
  DidLoadCrossReference2.create = function(value0) {
    return new DidLoadCrossReference2(value0);
  };
  return DidLoadCrossReference2;
}();
var DidCreatePericopeFromSelection = /* @__PURE__ */ function() {
  function DidCreatePericopeFromSelection2(value0) {
    this.value0 = value0;
  }
  ;
  DidCreatePericopeFromSelection2.create = function(value0) {
    return new DidCreatePericopeFromSelection2(value0);
  };
  return DidCreatePericopeFromSelection2;
}();
var DidLoadStory = /* @__PURE__ */ function() {
  function DidLoadStory2(value0) {
    this.value0 = value0;
  }
  ;
  DidLoadStory2.create = function(value0) {
    return new DidLoadStory2(value0);
  };
  return DidLoadStory2;
}();
var DictionaryIdle = /* @__PURE__ */ function() {
  function DictionaryIdle2() {
  }
  ;
  DictionaryIdle2.value = new DictionaryIdle2();
  return DictionaryIdle2;
}();
var DictionaryLoading = /* @__PURE__ */ function() {
  function DictionaryLoading2() {
  }
  ;
  DictionaryLoading2.value = new DictionaryLoading2();
  return DictionaryLoading2;
}();
var DictionaryLoaded = /* @__PURE__ */ function() {
  function DictionaryLoaded2(value0) {
    this.value0 = value0;
  }
  ;
  DictionaryLoaded2.create = function(value0) {
    return new DictionaryLoaded2(value0);
  };
  return DictionaryLoaded2;
}();
var CrossRefsIdle = /* @__PURE__ */ function() {
  function CrossRefsIdle2() {
  }
  ;
  CrossRefsIdle2.value = new CrossRefsIdle2();
  return CrossRefsIdle2;
}();
var CrossRefsLoading = /* @__PURE__ */ function() {
  function CrossRefsLoading2() {
  }
  ;
  CrossRefsLoading2.value = new CrossRefsLoading2();
  return CrossRefsLoading2;
}();
var CrossRefsLoaded = /* @__PURE__ */ function() {
  function CrossRefsLoaded2(value0) {
    this.value0 = value0;
  }
  ;
  CrossRefsLoaded2.create = function(value0) {
    return new CrossRefsLoaded2(value0);
  };
  return CrossRefsLoaded2;
}();
...
var HandlePericopeClick = /* @__PURE__ */ function() {
  function HandlePericopeClick2(value0) {
    this.value0 = value0;
  }
  ;
  HandlePericopeClick2.create = function(value0) {
    return new HandlePericopeClick2(value0);
  };
  return HandlePericopeClick2;
}();
var HandleAddressClick = /* @__PURE__ */ function() {
  function HandleAddressClick2(value0) {
    this.value0 = value0;
  }
  ;
  HandleAddressClick2.create = function(value0) {
    return new HandleAddressClick2(value0);
  };
  return HandleAddressClick2;
}();
var HandleSourceClick = /* @__PURE__ */ function() {
  function HandleSourceClick2(value0) {
    this.value0 = value0;
  }
  ;
  HandleSourceClick2.create = function(value0) {
    return new HandleSourceClick2(value0);
  };
  return HandleSourceClick2;
}();
var HandleSelectedAddressClick = /* @__PURE__ */ function() {
  function HandleSelectedAddressClick2(value0) {
    this.value0 = value0;
  }
  ;
  HandleSelectedAddressClick2.create = function(value0) {
    return new HandleSelectedAddressClick2(value0);
  };
  return HandleSelectedAddressClick2;
}();
var SwallowDidascaliaClick = /* @__PURE__ */ function() {
  function SwallowDidascaliaClick2(value0) {
    this.value0 = value0;
  }
  ;
  SwallowDidascaliaClick2.create = function(value0) {
    return new SwallowDidascaliaClick2(value0);
  };
  return SwallowDidascaliaClick2;
}();
var ToggleSelect = /* @__PURE__ */ function() {
  function ToggleSelect2(value0) {
    this.value0 = value0;
  }
  ;
  ToggleSelect2.create = function(value0) {
    return new ToggleSelect2(value0);
  };
  return ToggleSelect2;
}();
var SetAddress = /* @__PURE__ */ function() {
  function SetAddress2(value0) {
    this.value0 = value0;
  }
  ;
  SetAddress2.create = function(value0) {
    return new SetAddress2(value0);
  };
  return SetAddress2;
}();
...
var SubmitAddress = /* @__PURE__ */ function() {
  ...
  ;
  SubmitAddress2.value = new SubmitAddress2();
  return SubmitAddress2;
}();
var SubmitSource = /* @__PURE__ */ function() {
  function SubmitSource2() {
  }
  ;
  SubmitSource2.value = new SubmitSource2();
  return SubmitSource2;
}();
var CancelAddressEdit = /* @__PURE__ */ function() {
  function CancelAddressEdit2() {
  }
  ;
  CancelAddressEdit2.value = new CancelAddressEdit2();
  return CancelAddressEdit2;
}();
var CancelSourceEdit = /* @__PURE__ */ function() {
  function CancelSourceEdit2() {
  }
  ;
  CancelSourceEdit2.value = new CancelSourceEdit2();
  return CancelSourceEdit2;
}();
var CloseSourceList = /* @__PURE__ */ function() {
  function CloseSourceList2() {
  }
  ;
  CloseSourceList2.value = new CloseSourceList2();
  return CloseSourceList2;
}();
var SelectSource = /* @__PURE__ */ function() {
  function SelectSource2(value0) {
    this.value0 = value0;
  }
  ;
  SelectSource2.create = function(value0) {
    return new SelectSource2(value0);
  };
  return SelectSource2;
}();
...
var Duplicate2 = /* @__PURE__ */ function() {
  function Duplicate3() {
  }
  ;
  Duplicate3.value = new Duplicate3();
...
var DragStart2 = /* @__PURE__ */ function() {
  function DragStart3(value0) {
    this.value0 = value0;
  }
  ;
...
var DragOver2 = /* @__PURE__ */ function() {
  function DragOver3(value0) {
    this.value0 = value0;
  }
  ;
...
var DragLeave2 = /* @__PURE__ */ function() {
  function DragLeave3(value0) {
    this.value0 = value0;
  }
  ;
...
var OpenCrossReference = /* @__PURE__ */ function() {
  function OpenCrossReference2(value0) {
    this.value0 = value0;
  }
  ;
  OpenCrossReference2.create = function(value0) {
    return new OpenCrossReference2(value0);
  };
  return OpenCrossReference2;
}();
var OpenStory = /* @__PURE__ */ function() {
  function OpenStory2(value0) {
    this.value0 = value0;
  }
  ;
  OpenStory2.create = function(value0) {
    return new OpenStory2(value0);
  };
  return OpenStory2;
}();
var ToggleDictionaryTopic = /* @__PURE__ */ function() {
  function ToggleDictionaryTopic2(value0, value1) {
    this.value0 = value0;
    this.value1 = value1;
  }
  ;
  ToggleDictionaryTopic2.create = function(value0) {
    return function(value1) {
      return new ToggleDictionaryTopic2(value0, value1);
    };
  };
  return ToggleDictionaryTopic2;
}();
var launchFetch = function(dictMonadAff) {
  var liftAff4 = liftAff(monadAffHalogenM(dictMonadAff));
  return function(address2) {
    return function(source2) {
      return bind9(liftAff4(fetchVerses(address2)(source2)))(function(res) {
        if (res instanceof Left) {
          return pure18(unit);
        }
        ;
        if (res instanceof Right) {
          return discard13(modify_4(function(st) {
            ...
            ;
            $118.pericope = function() {
              var $115 = {};
              for (var $116 in st.pericope) {
                if ({}.hasOwnProperty.call(st.pericope, $116)) {
                  $115[$116] = st["pericope"][$116];
                }
                ;
              }
              ;
              $115.verses = res.value0;
              $115.selected = empty4;
              return $115;
            }();
            $118.crossRefs = CrossRefsIdle.value;
            $118.dictionary = DictionaryIdle.value;
            $118.activeDictionaryTopic = Nothing.value;
            return $118;
          }))(function() {
            return bind9(get5)(function(st$prime) {
              return raise(new DidUpdate2(st$prime.pericope));
            });
          });
        }
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 689, column 3 - line 699, column 39): " + [res.constructor.name]);
      });
    };
  };
};
var formatRange = function(start2) {
  return function(end) {
    if (start2 === end) {
      return show4(start2);
    }
    ;
    if (otherwise) {
      return show4(start2) + ("-" + show4(end));
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 743, column 1 - line 743, column 36): " + [start2.constructor.name, end.constructor.name]);
  };
};
var renderRanges = function(arr) {
  var go2 = function(start2) {
    return function(prev) {
      return function(rest) {
        var v2 = uncons(rest);
        if (v2 instanceof Nothing) {
          return [formatRange(start2)(prev)];
        }
        ;
        if (v2 instanceof Just) {
          if (v2.value0.head === (prev + 1 | 0)) {
            return go2(start2)(v2.value0.head)(v2.value0.tail);
          }
          ;
          if (otherwise) {
            return cons(formatRange(start2)(prev))(go2(v2.value0.head)(v2.value0.head)(v2.value0.tail));
          }
          ;
        }
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 737, column 5 - line 741, column 67): " + [v2.constructor.name]);
      };
    };
  };
  var v = uncons(arr);
  ...
  ;
  throw new Error("Failed pattern match at Pericope.Component (line 732, column 3 - line 734, column 45): " + [v.constructor.name]);
};
...
var addressPrefix = function(address2) {
  ...
  if (v instanceof Just) {
    return take3(v.value0 + 1 | 0)(address2);
  }
  ;
  if (v instanceof Nothing) {
    return "";
  ...
  ;
  throw new Error("Failed pattern match at Pericope.Component (line 726, column 3 - line 728, column 18): " + [v.constructor.name]);
};
var selectedAddressText = function(pericope) {
  var selectedAddresses = catMaybes(mapFlipped5(pericope.verses)(function(v) {
    var $137 = member3(v.verse_id)(pericope.selected);
    if ($137) {
      return new Just(v);
    }
    ;
  ...
  var renderSelection = function(arr) {
    var v = uncons(arr);
    if (v instanceof Nothing) {
      return [];
    }
    ;
    if (v instanceof Just) {
      var verses = mapFlipped5(cons(v.value0.head)(v.value0.tail))(function(v12) {
        return v12.verse;
      });
      var ranges = renderRanges(verses);
      var prefix = addressPrefix(v.value0.head.address);
      var v1 = uncons(ranges);
      if (v1 instanceof Nothing) {
        return [];
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Pericope.Component (line 717, column 11 - line 720, column 55): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 709, column 7 - line 720, column 55): " + [v.constructor.name]);
  };
  return joinWith(".")(renderSelection(selectedAddresses));
};
var handle2 = function(dictMonadAff) {
  var liftEffect9 = liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
  var liftAff4 = liftAff(monadAffHalogenM(dictMonadAff));
  ...
  return function(v) {
    ...
    ;
    if (v instanceof HandlePericopeClick) {
      return cancelEdits(dictMonadAff);
    }
    ;
    if (v instanceof HandleAddressClick) {
      return discard13(liftEffect9(stopPropagation(toEvent3(v.value0))))(function() {
        return modify_4(function(st) {
          ...
          ;
          $148.editingAddress = true;
          $148.originalAddress = new Just(st.pericope.address);
          return $148;
        });
      });
    }
    ...
    if (v instanceof HandleSourceClick) {
      return discard13(liftEffect9(stopPropagation(toEvent3(v.value0))))(function() {
        return discard13(modify_4(function(st) {
          ...
          ;
          $152.editingSource = true;
          $152.originalSource = new Just(st.pericope.source);
          return $152;
        }))(function() {
          return bind9(get5)(function(st) {
            ...
            if (st.sources instanceof Nothing) {
              return bind9(liftAff4(fetchSources))(function(res) {
                if (res instanceof Left) {
                ...
                if (res instanceof Right) {
                  return modify_4(function(v1) {
                    ...
                    ;
                    $162.sources = new Just(res.value0);
                    return $162;
                  });
                }
                ;
                throw new Error("Failed pattern match at Pericope.Component (line 432, column 9 - line 434, column 60): " + [res.constructor.name]);
              });
            }
            ;
            throw new Error("Failed pattern match at Pericope.Component (line 428, column 5 - line 434, column 60): " + [st.sources.constructor.name]);
          });
        });
      });
    }
    ...
    if (v instanceof SetAddress) {
      return modify_4(function(st) {
        ...
        ;
        $172.pericope = function() {
          var $169 = {};
          for (var $170 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $170)) {
              $169[$170] = st["pericope"][$170];
            }
            ;
          }
          ;
          $169.address = v.value0;
          return $169;
        }();
        return $172;
      });
    ...
    if (v instanceof SetSource) {
      return modify_4(function(st) {
        ...
        ;
        $179.pericope = function() {
          var $176 = {};
          for (var $177 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $177)) {
              $176[$177] = st["pericope"][$177];
            }
            ;
          }
          ;
    ...
    if (v instanceof SubmitAddress) {
      return bind9(get5)(function(st) {
        return discard13(modify_4(function(v1) {
          ...
          ;
          $183.editingAddress = false;
          $183.originalAddress = Nothing.value;
          return $183;
        }))(function() {
    ...
    if (v instanceof SubmitSource) {
      return bind9(get5)(function(st) {
        return discard13(modify_4(function(v1) {
          ...
          ;
          $189.editingSource = false;
          $189.originalSource = Nothing.value;
          return $189;
        }))(function() {
          return launchFetch1(st.pericope.address)(st.pericope.source);
        });
    ...
    if (v instanceof CancelAddressEdit) {
      return modify_4(function(st) {
        if (st.originalAddress instanceof Just) {
          ...
          ;
          $196.editingAddress = false;
          $196.originalAddress = Nothing.value;
          $196.pericope = function() {
            ...
            ;
            $193.address = st.originalAddress.value0;
            return $193;
          }();
          return $196;
        }
        ...
        if (st.originalAddress instanceof Nothing) {
          ...
          ;
          $200.editingAddress = false;
          $200.originalAddress = Nothing.value;
          return $200;
        }
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 473, column 7 - line 484, column 14): " + [st.originalAddress.constructor.name]);
      });
    }
    ;
    if (v instanceof CancelSourceEdit) {
      return modify_4(function(st) {
        if (st.originalSource instanceof Just) {
          ...
          ;
          $207.editingSource = false;
          $207.originalSource = Nothing.value;
          $207.pericope = function() {
            var $204 = {};
            for (var $205 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $205)) {
                $204[$205] = st["pericope"][$205];
              }
              ;
            }
            ;
            $204.source = st.originalSource.value0;
            return $204;
          }();
          return $207;
        }
        ...
        if (st.originalSource instanceof Nothing) {
          ...
          ;
          $211.editingSource = false;
          $211.originalSource = Nothing.value;
          return $211;
        }
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 488, column 7 - line 499, column 14): " + [st.originalSource.constructor.name]);
      });
    }
    ;
    if (v instanceof SelectSource) {
      return discard13(modify_4(function(st) {
        ...
        ;
        $217.pericope = function() {
          var $214 = {};
          for (var $215 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $215)) {
              $214[$215] = st["pericope"][$215];
            }
            ;
          }
          ;
        ...
        $217.editingSource = false;
        $217.originalSource = Nothing.value;
        return $217;
      }))(function() {
        return bind9(get5)(function(st) {
    ...
    if (v instanceof ToggleSelect) {
      return discard13(modify_4(function(st) {
        var sel1 = function() {
          var $221 = member3(v.value0)(st.pericope.selected);
          if ($221) {
        ...
        var nextDictionaryState = function() {
          var $222 = size3(sel1) === 1;
          if ($222) {
            return DictionaryLoading.value;
          }
          ;
          return DictionaryIdle.value;
        }();
        var hasSelection = size3(sel1) >= 1;
        ...
        ;
        $227.pericope = function() {
          var $224 = {};
          for (var $225 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $225)) {
              $224[$225] = st["pericope"][$225];
            }
            ;
          }
          ;
        ...
        $227.crossRefs = nextCrossRefState;
        $227.dictionary = nextDictionaryState;
        $227.activeDictionaryTopic = Nothing.value;
        return $227;
      }))(function() {
        return bind9(get5)(function(st) {
          return discard13(raise(new DidUpdate2(st.pericope)))(function() {
            var selectionStillMatches = bind9(get5)(function(st$prime) {
              return pure18(eq12(st$prime.pericope.selected)(st.pericope.selected));
            });
            var selectedIds = toUnfoldable5(st.pericope.selected);
            var addressText = selectedAddressText(st.pericope);
            return discard13(when5(addressText !== "")(bind9(liftAff4(fetchCrossReferences(addressText)(st.pericope.source)))(function(refsRes) {
              return bind9(selectionStillMatches)(function(stillValid) {
                return when5(stillValid)(function() {
                  var refs = function() {
                    if (refsRes instanceof Left) {
                      return [];
                    }
                    ;
                    if (refsRes instanceof Right) {
                      return refsRes.value0;
                    }
                    ;
                    throw new Error("Failed pattern match at Pericope.Component (line 542, column 22 - line 544, column 49): " + [refsRes.constructor.name]);
                  }();
                  return modify_4(function(s) {
                    ...
                    ;
                    $235.crossRefs = function() {
                      if (s.crossRefs instanceof CrossRefsLoaded) {
                        return new CrossRefsLoaded({
                          commentaries: s.crossRefs.value0.commentaries,
                          stories: s.crossRefs.value0.stories,
                          references: refs
                        });
                      }
                      ;
              ...
              if (selectedIds.length === 1) {
                var selectedVerse = find2(function(v1) {
                  return v1.verse_id === selectedIds[0];
                })(st.pericope.verses);
                if (selectedVerse instanceof Nothing) {
                  return pure18(unit);
                }
                ;
                if (selectedVerse instanceof Just) {
                  return bind9(liftAff4(fetchVerseDictionary(selectedIds[0])))(function(dictionaryRes) {
                    return bind9(selectionStillMatches)(function(stillValid) {
                      return discard13(when5(stillValid)(function() {
                        var dictionaryEntries = function() {
                          if (dictionaryRes instanceof Left) {
                            return [];
                          }
                          ;
                          if (dictionaryRes instanceof Right) {
                            return dictionaryRes.value0;
                          }
                          ;
                          throw new Error("Failed pattern match at Pericope.Component (line 562, column 41 - line 564, column 47): " + [dictionaryRes.constructor.name]);
                        }();
                        return modify_4(function(v2) {
                          ...
                          ;
                          $244.dictionary = new DictionaryLoaded(dictionaryEntries);
                          $244.activeDictionaryTopic = Nothing.value;
                          return $244;
                        });
                      }()))(function() {
                        return bind9(liftAff4(fetchCommentaries(selectedIds[0])))(function(commRes) {
                          return bind9(selectionStillMatches)(function(stillValid2) {
                            return when5(stillValid2)(bind9(liftAff4(fetchRenderedStories(selectedVerse.value0.source)(selectedVerse.value0.address)))(function(storiesRes) {
                              return bind9(selectionStillMatches)(function(stillValid3) {
                                return when5(stillValid3)(function() {
                                  var stories = function() {
                                    if (storiesRes instanceof Left) {
                                      return [];
                                    }
                                    ;
                                    if (storiesRes instanceof Right) {
                                      return storiesRes.value0;
                                    }
                                    ;
                                    throw new Error("Failed pattern match at Pericope.Component (line 579, column 31 - line 581, column 61): " + [storiesRes.constructor.name]);
                                  }();
                                  var commentaries = function() {
                                    ...
                                    if (commRes instanceof Right) {
                                      return map30(annotateCommentary(selectedVerse.value0.source))(commRes.value0);
                                    }
                                    ;
                                    throw new Error("Failed pattern match at Pericope.Component (line 576, column 36 - line 578, column 103): " + [commRes.constructor.name]);
                                  }();
                                  return modify_4(function(s) {
                                    var $255 = {};
                                    for (var $256 in s) {
                                    ...
                                    ;
                                    $255.crossRefs = function() {
                                      if (s.crossRefs instanceof CrossRefsLoaded) {
                                        return new CrossRefsLoaded({
                                          references: s.crossRefs.value0.references,
                                          commentaries,
                                          stories
                                        });
                                      }
                ...
                ;
                throw new Error("Failed pattern match at Pericope.Component (line 556, column 11 - line 586, column 22): " + [selectedVerse.constructor.name]);
              }
              ;
              return pure18(unit);
            });
    ...
    ;
    if (v instanceof Remove2) {
      return bind9(get5)(function(st) {
        return raise(new DidRemove2(st.pericope.id));
      });
    }
    ;
    if (v instanceof Duplicate2) {
      return bind9(get5)(function(st) {
        return raise(new DidDuplicate2({
          id: st.pericope.id
        }));
      });
    }
    ;
    if (v instanceof DragStart2) {
      return discard13(liftEffect9(stopPropagation(toEvent(v.value0))))(function() {
        return bind9(get5)(function(st) {
          return raise(new DidStartDrag2(st.pericope.id));
        });
      });
    }
    ;
    if (v instanceof DragOver2) {
      return discard13(liftEffect9(function __do2() {
        preventDefault(toEvent(v.value0))();
        return stopPropagation(toEvent(v.value0))();
      }))(function() {
        return bind9(get5)(function(st) {
          return raise(new DidDragOver2(st.pericope.id));
        });
      });
    }
    ;
    if (v instanceof DragLeave2) {
      return bind9(get5)(function(st) {
        return raise(new DidDragLeave2(st.pericope.id));
      });
    }
    ;
    if (v instanceof Drop2) {
      return discard13(liftEffect9(function __do2() {
        preventDefault(toEvent(v.value0))();
        return stopPropagation(toEvent(v.value0))();
      }))(function() {
        return bind9(get5)(function(st) {
          return raise(new DidReorder2({
            from: st.pericope.id,
            to: st.pericope.id
          }));
        });
    ...
    if (v instanceof Receive3) {
      return modify_4(function(st) {
        var shouldResetSelection = isEmpty2(v.value0.selected);
        ...
        var nextTopic = function() {
          ...
          ;
          return st.activeDictionaryTopic;
        }();
        var nextDictionary = function() {
          if (shouldResetSelection) {
            return DictionaryIdle.value;
          }
          ;
        ...
        ;
        $270.pericope = v.value0;
        $270.crossRefs = nextCrossRefs;
        $270.dictionary = nextDictionary;
        $270.activeDictionaryTopic = nextTopic;
        $270.editingSource = function() {
    ...
    ;
    if (v instanceof OpenCrossReference) {
      return bind9(get5)(function(st) {
        return raise(new DidLoadCrossReference({
          source: st.pericope.source,
          address: v.value0
        }));
      });
    ...
    ;
    if (v instanceof OpenStory) {
      return raise(new DidLoadStory(v.value0));
    }
    ;
    if (v instanceof ToggleDictionaryTopic) {
      return discard13(liftEffect9(stopPropagation(toEvent3(v.value0))))(function() {
        return modify_4(function(st) {
          var next = function() {
            var $276 = eq3(st.activeDictionaryTopic)(new Just(v.value1));
            if ($276) {
              return Nothing.value;
            }
            ;
          ...
          ;
          $277.activeDictionaryTopic = next;
          return $277;
        });
      });
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 405, column 10 - line 655, column 42): " + [v.constructor.name]);
  };
};
...
var handleQuery2 = function(dictMonadAff) {
  var launchFetch1 = launchFetch(dictMonadAff);
  var cancelEdits1 = cancelEdits(dictMonadAff);
  return function(v) {
    ...
    if (v instanceof Refresh) {
      return bind9(get5)(function(st) {
        return discard13(launchFetch1(st.pericope.address)(st.pericope.source))(function() {
          return pure18(new Just(v.value0));
        });
      });
    }
    ;
    if (v instanceof CancelEditing) {
      return discard13(cancelEdits1)(function() {
        return pure18(new Just(v.value0));
      });
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 662, column 15 - line 672, column 18): " + [v.constructor.name]);
  };
};
var render2 = function(st) {
  var sourceNode = function() {
    if (st.editingSource) {
      var sourceList = function() {
        if (st.sources instanceof Nothing) {
          return [div2([class_("source-loading")])([text5("Loading sources...")])];
        }
        ;
        if (st.sources instanceof Just) {
          var $292 = $$null(st.sources.value0);
          if ($292) {
            return [div2([class_("source-empty")])([text5("Unable to load sources.")])];
          }
          ;
          var filterValue = toLower(st.pericope.source);
          var matchesFilter = function(infoRec) {
            var info2 = unwrap6(infoRec);
            var haystack = toLower(info2.name) + (" " + toLower(info2.description_short));
            return filterValue === "" || contains(filterValue)(haystack);
          };
          var filteredInfos = filter(matchesFilter)(st.sources.value0);
          var $293 = $$null(filteredInfos);
          if ($293) {
            return [div2([class_("source-empty")])([text5("No sources match your search.")])];
          }
          ;
          var renderOption = function(infoRec) {
            var info2 = unwrap6(infoRec);
            var isActive = info2.name === st.pericope.source;
            var cls = "source-option" + function() {
              if (isActive) {
                return " active";
              }
              ;
            ...
            return li([class_(cls), onClick(function(v) {
              return new SelectSource(info2.name);
            })])([div2([class_("source-option-name")])([text5(info2.name)]), div2([class_("source-option-description")])([text5(info2.description_short)])]);
          };
          var renderGroup = function(lang2) {
            var entries = filter(function(infoRec) {
              return unwrap6(infoRec).language === lang2;
            })(filteredInfos);
            var sorted = sortBy(comparing2(function($316) {
              return function(v) {
                return v.name;
              }(unwrap6($316));
            }))(entries);
            return div2([class_("source-language-group")])([h4([class_("source-language")])([text5(lang2)]), ul([class_("source-options list-reset")])(map30(renderOption)(sorted))]);
          };
          var languages2 = toUnfoldable5(fromFoldable6(mapFlipped5(filteredInfos)(function($317) {
            return function(v) {
              return v.language;
            }(unwrap6($317));
          })));
          var sortedLanguages = sort2(languages2);
          return [div2([class_("source-list list")])(map30(renderGroup)(sortedLanguages))];
        }
        ;
    ...
    ;
    return div2([class_("source"), onClick(HandleSourceClick.create)])([text5(st.pericope.source)]);
  }();
  ...
  var renderDictionaryEntry = function(v) {
    var isActive = eq3(st.activeDictionaryTopic)(new Just(v.topic));
    var formsList = function() {
      var $300 = $$null(v.forms);
      if ($300) {
        return [li([class_("dictionary-form-item empty")])([text5("\u2014")])];
      }
      ;
      return mapFlipped5(v.forms)(function(form2) {
        return li([class_("dictionary-form-item")])([text5(trim(form2))]);
      });
    }();
    var tooltip = function() {
      if (isActive) {
        return [div2([class_("dictionary-tooltip")])([div2([class_("dictionary-topic")])([text5(v.topic)]), div2([class_("dictionary-meaning")])([text5(v.meaning)]), div2([class_("dictionary-parse")])([text5(v.parse)]), div2([class_("dictionary-forms")])([span4([class_("dictionary-forms-label")])([text5("Forms")]), ul([class_("dictionary-forms-list list-reset")])(formsList)])])];
      }
      ;
      return [];
    }();
    return div2([class_("dictionary-entry" + function() {
      if (isActive) {
        return " active";
      }
      ;
  ...
  var renderDictionary = function() {
    if (st.dictionary instanceof DictionaryIdle) {
      return [];
    }
    ;
    if (st.dictionary instanceof DictionaryLoading) {
      return [];
    }
    ;
    if (st.dictionary instanceof DictionaryLoaded) {
      var $304 = $$null(st.dictionary.value0);
      if ($304) {
        return [];
      }
      ;
      return [div2([class_("dictionary")])(map30(renderDictionaryEntry)(st.dictionary.value0))];
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 238, column 7 - line 249, column 14): " + [st.dictionary.constructor.name]);
  }();
  var renderCommentary = function(v) {
    return div2([class_("commentary")])([span4([class_("commentary-marker")])([text5(v.marker)]), span4([class_("commentary-text"), prop4("innerHTML")(v.text)])([])]);
  };
  var renderCrossRefs = function() {
    ...
    ;
    if (st.crossRefs instanceof CrossRefsLoading) {
      return [div2([class_("cross-references-loading")])([text5("Loading cross references...")])];
    }
    ;
    if (st.crossRefs instanceof CrossRefsLoaded) {
      var storyNodes = function() {
        var $308 = $$null(st.crossRefs.value0.stories);
        if ($308) {
          return [];
        }
        ;
        return [div2([class_("stories")])(map30(renderStory)(st.crossRefs.value0.stories))];
      }();
      var crossReferenceNodes = function() {
        var $309 = $$null(st.crossRefs.value0.references);
        if ($309) {
          return [];
        }
        ;
        return [div2([class_("cross-references")])(map30(renderRef)(st.crossRefs.value0.references))];
      }();
      var commentaryNodes = function() {
        var $310 = $$null(st.crossRefs.value0.commentaries);
        if ($310) {
          return [];
        }
        ;
  ...
  var addressNode = function() {
    if (st.editingAddress) {
      return div2([class_("address editing"), onClick(SwallowDidascaliaClick.create)])([input2([value15(st.pericope.address), onValueInput(SetAddress.create), onKeyDown(function(ke) {
        var v = key(ke);
        if (v === "Enter") {
          return SubmitAddress.value;
        }
        ;
        if (v === "Escape") {
          return CancelAddressEdit.value;
        }
        ;
        return Noop.value;
      }), autofocus6(true)])]);
  ...
  return div2([class_("pericope"), onClick(HandlePericopeClick.create)])([div2([class_("didascalia"), draggable2(true), onDragStart(DragStart2.create), onDragLeave(DragLeave2.create), onDragOver(DragOver2.create), onDrop(Drop2.create)])([div2([class_("didascalia-handle-group")])([div2([class_("didascalia-handle")])([text5("\u2630")]), button([class_("didascalia-duplicate icon-button"), title2("duplicate pericope"), onClick(function(v) {
    return Duplicate2.value;
  })])([text5("\u29C9")]), button([class_("didascalia-remove icon-button"), title2("remove pericope"), onClick(function(v) {
    return Remove2.value;
  })])([text5("\u2715")])]), addressNode, sourceNode]), div2([class_("textus")])(mapFlipped5(st.pericope.verses)(function(v) {
    var sel = member3(v.verse_id)(st.pericope.selected);
    return div2([class_("verse" + function() {
      if (sel) {
        return " selected";
      }
      ;
...
var component2 = function(dictMonadAff) {
  return mkComponent({
    initialState: function(p2) {
      return {
        pericope: p2,
        editingAddress: false,
        editingSource: false,
        sources: Nothing.value,
        originalAddress: Nothing.value,
        originalSource: Nothing.value,
        crossRefs: CrossRefsIdle.value,
        dictionary: DictionaryIdle.value,
        activeDictionaryTopic: Nothing.value
      };
    },
    render: render2,
    "eval": mkEval({
      initialize: defaultEval.initialize,
      finalize: defaultEval.finalize,
      handleAction: handle2(dictMonadAff),
      handleQuery: handleQuery2(dictMonadAff),
      receive: function($318) {
        return Just.create(Receive3.create($318));
      }
    })
  });
};
...
function splitSearchInput(input3) {
  ...
  let lastIndex = 0;
  let match;
  while ((match = pattern2.exec(input3)) !== null) {
    const start2 = match.index;
    if (start2 > lastIndex) {
      segments.push({ text: input3.slice(lastIndex, start2), color: null });
    }
  ...
  if (lastIndex < input3.length) {
    segments.push({ text: input3.slice(lastIndex), color: null });
  }
  return segments;
}

// output/Search.Highlight/index.js
var toMaybeColor = function(segment) {
...
var stripTags = /* @__PURE__ */ function() {
  var go2 = function(insideTag) {
    return function(chars) {
      ...
      ;
      throw new Error("Failed pattern match at Search.Component (line 232, column 5 - line 238, column 50): " + [v.constructor.name]);
    };
  };
  var $86 = go2(false);
  return function($87) {
...
var renderSearchResults = function(toParentAction) {
  return function(st) {
    var results = mapFlipped6(st.searchResults)(renderSearchResult(toParentAction));
    var $38 = !st.searchOpen || $$null(results);
    if ($38) {
      return [];
    }
    ;
...
var renderSearchInputHighlights = function(input3) {
  ...
  ;
  return mapFlipped6(segments)(renderSegment);
};
var renderSearchFeedback = function(st) {
  ...
  ;
  throw new Error("Failed pattern match at Search.Component (line 151, column 6 - line 160, column 14): " + [st.searchLoading.constructor.name, st.searchError.constructor.name]);
};
...
var handleAction = function(insertPericope2) {
  return function(action2) {
    ...
    if (action2 instanceof SubmitSearch) {
      return bind10(get6)(function(st) {
        ...
        ;
        return discard7(modify_5(function(state3) {
          var $53 = {};
          ...
          return bind10(liftAff2(searchVerses(query3)))(function(res) {
    ...
    if (action2 instanceof ReceiveSearchResults) {
      ...
      ;
      throw new Error("Failed pattern match at Search.Component (line 100, column 31 - line 113, column 10): " + [action2.value0.constructor.name]);
    }
    ;
    if (action2 instanceof SelectSearchResult) {
      ...
      return discard7(modify_5(function(st) {
        ...
        return bind10(liftAff2(fetchVerses(details2.address)(details2.source)))(function(res) {
          if (res instanceof Left) {
            return pure19(unit);
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Search.Component (line 119, column 5 - line 121, column 75): " + [res.constructor.name]);
        });
      });
    }
    ;
    if (action2 instanceof FocusSearchInput) {
      return modify_5(function(st) {
        var $75 = st.searchPerformed || (st.searchLoading || function() {
          ...
          ;
          throw new Error("Failed pattern match at Search.Component (line 125, column 53 - line 127, column 29): " + [st.searchError.constructor.name]);
        }());
        if ($75) {
          var $76 = {};
          for (var $77 in st) {
    ...
    ;
    throw new Error("Failed pattern match at Search.Component (line 79, column 38 - line 145, column 48): " + [action2.constructor.name]);
  };
};
...
var discard14 = /* @__PURE__ */ discard8(bindHalogenM);
...
var slot1 = /* @__PURE__ */ slot2(pericopeIsSymbol)(ordInt);
...
var PericopeMsg = /* @__PURE__ */ function() {
  ...
  ;
  PericopeMsg2.create = function(value0) {
    return function(value1) {
      return new PericopeMsg2(value0, value1);
    };
  };
  return PericopeMsg2;
}();
var NoteMsg = /* @__PURE__ */ function() {
  function NoteMsg2(value0, value1) {
    this.value0 = value0;
    this.value1 = value1;
  }
  ;
  NoteMsg2.create = function(value0) {
    return function(value1) {
      return new NoteMsg2(value0, value1);
    };
  };
  return NoteMsg2;
}();
...
var AddPericope = /* @__PURE__ */ function() {
  function AddPericope2(value0, value1, value22) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value22;
  }
  ;
  AddPericope2.create = function(value0) {
    return function(value1) {
      return function(value22) {
        return new AddPericope2(value0, value1, value22);
      };
    };
  };
  return AddPericope2;
}();
var AddNoteAt = /* @__PURE__ */ function() {
  function AddNoteAt2(value0) {
    this.value0 = value0;
  }
  ;
  AddNoteAt2.create = function(value0) {
...
var DownloadMarkdown = /* @__PURE__ */ function() {
  ...
  ;
  DownloadMarkdown2.value = new DownloadMarkdown2();
  return DownloadMarkdown2;
}();
var ChildMsg = /* @__PURE__ */ function() {
  function ChildMsg2(value0) {
    this.value0 = value0;
  }
  ;
  ChildMsg2.create = function(value0) {
    return new ChildMsg2(value0);
  };
  return ChildMsg2;
}();
...
var OverDrag = /* @__PURE__ */ function() {
  function OverDrag2(value0) {
    this.value0 = value0;
  }
  ;
  OverDrag2.create = function(value0) {
    return new OverDrag2(value0);
  };
  return OverDrag2;
}();
var LeaveDrag = /* @__PURE__ */ function() {
  function LeaveDrag2(value0) {
    this.value0 = value0;
  }
  ;
  LeaveDrag2.create = function(value0) {
    return new LeaveDrag2(value0);
  };
  return LeaveDrag2;
}();
var DropOn = /* @__PURE__ */ function() {
  function DropOn2(value0) {
    this.value0 = value0;
  }
  ;
  DropOn2.create = function(value0) {
    return new DropOn2(value0);
  };
  return DropOn2;
}();
...
var ToggleSheetList = /* @__PURE__ */ function() {
  function ToggleSheetList2() {
  }
  ;
  ToggleSheetList2.value = new ToggleSheetList2();
  return ToggleSheetList2;
}();
var RecallSheet = /* @__PURE__ */ function() {
  function RecallSheet2(value0) {
    this.value0 = value0;
  }
  ;
  RecallSheet2.create = function(value0) {
    return new RecallSheet2(value0);
  };
  return RecallSheet2;
}();
var DeleteSavedSheet = /* @__PURE__ */ function() {
  function DeleteSavedSheet2(value0) {
    this.value0 = value0;
  }
  ;
  DeleteSavedSheet2.create = function(value0) {
    return new DeleteSavedSheet2(value0);
  };
...
var updatePericope = function(updated) {
  return function(v) {
    if (v instanceof PericopeItem && v.value0.id === updated.id) {
      return new PericopeItem(updated);
    }
    ;
    return v;
  };
};
var updateNote = function(updated) {
  return function(v) {
    if (v instanceof NoteItem && v.value0.id === updated.id) {
      return new NoteItem(updated);
    }
    ;
    return v;
  };
...
var syncSheet = /* @__PURE__ */ bind11(get7)(function(st) {
  ...
  return discard14(liftEffect8(function __do2() {
    saveSheetToLocal(st.sheetId)(payload)();
    return launchAff_($$void7(upsertSheet(st.sheetId)(payload)))();
  }))(function() {
...
var sheetMarkdownFilename = function(title4) {
  return function(sheetId) {
    var slug = slugify(title4);
    var v = sheetId === "";
    var v1 = slug === "";
    if (v1 && v) {
...
var renderPericope2 = function(p2) {
  return slot1(pericopeSlot)(p2.id)(component1)(p2)(function(out) {
    return new ChildMsg(new PericopeMsg(p2.id, out));
  });
};
var pericopeSeed = function(address2) {
  return function(source2) {
    return {
      kind: "pericope",
      address: address2,
...
var noteSlot = /* @__PURE__ */ function() {
  return $$Proxy.value;
}();
var renderNote = function(n) {
  return slot22(noteSlot)(n.id)(component22)(n)(function(out) {
    return new ChildMsg(new NoteMsg(n.id, out));
  });
};
var renderItem2 = function(item) {
  if (item instanceof PericopeItem) {
    return renderPericope2(item.value0);
  }
  ;
...
var itemId = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at App.Main (line 515, column 10 - line 517, column 21): " + [v.constructor.name]);
};
var removeItemById = function(rid) {
  return updateItemsAndSync(filter(function(item) {
    return itemId(item) !== rid;
  }));
};
var reorder = function(fromId) {
  return function(toId) {
    return function(arr) {
      var findIndexById = function(id3) {
        return findIndex(function(item) {
          return itemId(item) === id3;
        })(arr);
      };
      var fromIx = findIndexById(fromId);
      var toIx = findIndexById(toId);
      if (fromIx instanceof Just && toIx instanceof Just) {
        var v = deleteAt(fromIx.value0)(arr);
        var v1 = index(arr)(fromIx.value0);
        if (v1 instanceof Just && v instanceof Just) {
          return fromMaybe(v.value0)(insertAt(toIx.value0)(v1.value0)(v.value0));
        }
        ;
        return arr;
      }
...
var insertNoteAt = function(index4) {
...
var insertNoteAtEnd = function(content3) {
  return bind11(get7)(function(st) {
    return insertNoteAt(length(st.items))(content3);
  });
};
...
var renderSheetEntry = function(currentSheetId) {
  return function(entry) {
    ...
    var isCurrent = entry.sheetId === currentSheetId;
    var classes = "sheet-list-entry" + function() {
      if (isCurrent) {
        return " sheet-list-entry--current";
      }
      ;
      return "";
    }();
    return div2([class_(classes)])([button([class_("sheet-list-title"), title2(entry.sheetId), onClick(function(v) {
      return new RecallSheet(entry.sheetId);
    })])([text5(label5)]), span4([class_("sheet-list-date")])([text5(formatSavedAt(entry.savedAt))]), function() {
      if (isCurrent) {
        return text5("");
      }
      ;
      return button([class_("sheet-list-delete"), title2("remove from list"), onClick(function(v) {
        return new DeleteSavedSheet(entry.sheetId);
      })])([text5("\xD7")]);
    }()]);
  };
};
var renderSheetList = function(currentSheetId) {
  return function(sheets) {
    return div2([class_("sheet-list")])(function() {
      ...
      ;
      return mapFlipped7(sheets)(renderSheetEntry(currentSheetId));
    }());
  };
};
var renderFooter = function(st) {
  return div2([class_("app-footer-container")])(append15(function() {
    if (st.sheetListOpen) {
      return [renderSheetList(st.sheetId)(st.savedSheets)];
    }
    ;
    return [];
  }())([div2([class_("app-footer")])([button([class_("app-footer-action"), title2("saved sheets"), onClick(function(v) {
    return ToggleSheetList.value;
  })])([text5("sheets (" + (show5(length(st.savedSheets)) + ")"))]), button([class_("app-footer-action"), title2("download sheet as markdown"), onClick(function(v) {
...
var findPericope = function(pid) {
  return function(items2) {
    return findMap(function(v) {
      if (v instanceof PericopeItem && v.value0.id === pid) {
...
var findNote = function(nid) {
  return function(items2) {
    return bind16(findIndex(function(item) {
      return itemId(item) === nid;
    })(items2))(function(index4) {
      var v = index(items2)(index4);
      if (v instanceof Just && v.value0 instanceof NoteItem) {
        return new Just({
          index: index4,
          note: v.value0.value0
        });
      }
      ;
      return Nothing.value;
  ...
  return function(address2) {
    return function(source2) {
      return bind11(liftAff3(fetchVerses(address2)(source2)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at App.Main (line 489, column 3 - line 491, column 65): " + [res.constructor.name]);
      });
    };
  };
};
var fetchAndInsertPericope = function(address2) {
  return function(source2) {
    return bind11(liftAff3(fetchVerses(address2)(source2)))(function(res) {
      ...
      ;
      throw new Error("Failed pattern match at App.Main (line 478, column 3 - line 480, column 57): " + [res.constructor.name]);
    });
  };
};
var loadSeed = function(v) {
  if (v.kind === "note") {
    return insertNoteAtEnd(v.content);
  }
  ;
  var $138 = v.address !== "" && v.source !== "";
  if ($138) {
...
var handlePericopeOutput = function(pid) {
  return function(v) {
    if (v instanceof DidDuplicate2) {
      return bind11(get7)(function(st) {
        var v1 = findPericope(v.value0.id)(st.items);
        if (v1 instanceof Nothing) {
          return pure20(unit);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at App.Main (line 396, column 5 - line 398, column 58): " + [v1.constructor.name]);
      });
    }
    ;
    if (v instanceof DidRemove2) {
      return removeItemById(v.value0);
    }
    ;
    if (v instanceof DidStartDrag2) {
      return handle3(new StartDrag(pid));
    }
    ;
    if (v instanceof DidDragOver2) {
      return handle3(new OverDrag(pid));
    }
    ;
    if (v instanceof DidDragLeave2) {
      return handle3(new LeaveDrag(pid));
    }
    ;
    if (v instanceof DidReorder2) {
      return handle3(new DropOn(pid));
    }
    ;
    if (v instanceof DidUpdate2) {
      return updateItemsAndSync(function(items2) {
        return mapFlipped7(items2)(updatePericope(v.value0));
      });
    }
    ;
    if (v instanceof DidLoadCrossReference) {
      return fetchAndInsertPericope(v.value0.address)(v.value0.source);
    }
    ;
    if (v instanceof DidCreatePericopeFromSelection) {
      return fetchAndInsertPericope(v.value0.address)(v.value0.source);
    }
    ;
    if (v instanceof DidLoadStory) {
      return fetchAndInsertPericope(v.value0.address)(v.value0.source);
    }
    ;
    throw new Error("Failed pattern match at App.Main (line 393, column 28 - line 425, column 42): " + [v.constructor.name]);
  };
};
var handleNoteOutput = function(nid) {
  return function(v) {
    if (v instanceof DidDuplicate) {
      return bind11(get7)(function(st) {
        var v1 = findNote(v.value0.id)(st.items);
        if (v1 instanceof Nothing) {
          return pure20(unit);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at App.Main (line 434, column 5 - line 436, column 68): " + [v1.constructor.name]);
      });
    }
    ;
    if (v instanceof DidRemove) {
      return removeItemById(v.value0);
    }
    ;
    if (v instanceof DidStartDrag) {
      return handle3(new StartDrag(nid));
    }
    ;
    if (v instanceof DidDragOver) {
      return handle3(new OverDrag(nid));
    }
    ;
    if (v instanceof DidDragLeave) {
      return handle3(new LeaveDrag(nid));
    }
    ;
    if (v instanceof DidReorder) {
      return handle3(new DropOn(nid));
    }
    ;
    if (v instanceof DidUpdate) {
      return updateItemsAndSync(function(items2) {
        return mapFlipped7(items2)(updateNote(v.value0));
      });
    }
    ;
    throw new Error("Failed pattern match at App.Main (line 431, column 24 - line 454, column 64): " + [v.constructor.name]);
  };
};
var handle3 = function(action2) {
          ...
          return bind11(liftAff3(fetchSheet(sheetId)))(function(res) {
            var loaded = function() {
              ...
              if (res instanceof Right) {
                ...
                ;
                throw new Error("Failed pattern match at App.Main (line 303, column 30 - line 305, column 50): " + [res.value0.constructor.name]);
              }
              ;
              throw new Error("Failed pattern match at App.Main (line 301, column 18 - line 305, column 50): " + [res.constructor.name]);
            }();
            var seeds = function() {
              var $183 = $$null(loaded.items);
              if ($183) {
                return defaultSeeds;
              }
              ;
              ...
              return discard14(for_3(seeds)(loadSeed))(function() {
                return discard14(modify_6(function(st) {
                  ...
                  return bind11(liftEffect8(getSearchQueryParam))(function(rawQuery) {
                    ...
                    ;
                    return discard14(handleAction(insertPericope)(new UpdateSearchInput(rawQuery)))(function() {
  ...
  ;
  if (action2 instanceof AddNoteAt) {
  ...
  if (action2 instanceof DownloadMarkdown) {
    return bind11(get7)(function(st) {
      ...
      var filename = sheetMarkdownFilename(st.title)(st.sheetId);
  ...
  if (action2 instanceof ToggleSheetList) {
    return modify_6(function(st) {
      var $197 = {};
      for (var $198 in st) {
        if ({}.hasOwnProperty.call(st, $198)) {
          $197[$198] = st[$198];
        }
        ;
      }
      ;
      $197.sheetListOpen = !st.sheetListOpen;
      return $197;
    });
  }
  ;
  if (action2 instanceof RecallSheet) {
    return liftEffect8(navigateToSheet(action2.value0));
  }
  ;
  if (action2 instanceof DeleteSavedSheet) {
  ...
  if (action2 instanceof StartDrag) {
    return modify_6(function(st) {
      ...
      ;
      $209.dragging = new Just(action2.value0);
      return $209;
    });
  }
  ;
  if (action2 instanceof OverDrag) {
    return modify_6(function(st) {
      ...
      ;
      $213.droppingOver = new Just(action2.value0);
      return $213;
    });
  }
  ;
  if (action2 instanceof LeaveDrag) {
    return modify_6(function(st) {
      ...
      ;
      $217.droppingOver = Nothing.value;
      return $217;
    });
  }
  ;
    ...
    return bind11(get7)(function(st) {
      ...
      if (st.dragging instanceof Just) {
        ...
        return discard14(put3(function() {
          ...
          ;
          $222.items = items2;
          $222.dragging = Nothing.value;
          $222.droppingOver = Nothing.value;
          return $222;
        }()))(function() {
          return syncSheet;
        });
      ...
      ;
      throw new Error("Failed pattern match at App.Main (line 368, column 5 - line 373, column 18): " + [st.dragging.constructor.name]);
    });
  }
  ;
  if (action2 instanceof ChildMsg) {
    if (action2.value0 instanceof PericopeMsg) {
      return handlePericopeOutput(action2.value0.value0)(action2.value0.value1);
    }
    ;
    if (action2.value0 instanceof NoteMsg) {
      return handleNoteOutput(action2.value0.value0)(action2.value0.value1);
    }
    ;
    throw new Error("Failed pattern match at App.Main (line 375, column 19 - line 379, column 31): " + [action2.value0.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at App.Main (line 295, column 17 - line 379, column 31): " + [action2.constructor.name]);
};
