...
var searchVerses = function(query2) {
  var encoded = encodeURIComponent2(query2);
  var url = baseUrl + ("/_all_verses?text_search=phfts.%22" + (encoded + "%22"));
  return bind3(get2(driver)(json2)(url))(function(res) {
    if (res instanceof Left) {
      return pure5(new Left("HTTP error: " + printError(res.value0)));
    }
...
var addForeignPropHandler = function(key2) {
  return function(prop5) {
    return function(reader) {
      return function(f) {
        var go2 = function(a2) {
          return composeKleisliFlipped5(reader)(readProp2(prop5))(unsafeToForeign(a2));
        };
...
var getHTMLElementRef = /* @__PURE__ */ function() {
  var $24 = map(functorHalogenM)(function(v) {
    return bindFlipped7(fromElement)(v);
  });
  return function($25) {
    return $24(getRef($25));
  };
...
var evalQ = function(render3) {
  return function(ref3) {
    return function(q2) {
      return bind12(liftEffect4(read(ref3)))(function(v) {
        return evalM(render3)(ref3)(v["component"]["eval"](new Query(map21(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
      });
    };
  };
};
...
var runUI2 = function(component3) {
  return function(i2) {
    return function(element3) {
      return bind14(liftEffect6(map25(toDocument)(bindFlipped10(document)(windowImpl))))(function(document2) {
...
var selectedAddressText = function(pericope) {
  var selectedAddresses = catMaybes(mapFlipped3(pericope.verses)(function(v) {
    var $84 = member3(v.verse_id)(pericope.selected);
    if ($84) {
      return new Just(v);
    }
    ;
  ...
  var renderSelection = function(arr) {
    ...
    if (v instanceof Just) {
      ...
      ;
      if (otherwise) {
        return append5(renderSelection(v.value0.tail))([show3(v.value0.head.verse)]);
      }
      ;
    }
    ;
    throw new Error("Failed pattern match at Pericope (line 505, column 7 - line 509, column 64): " + [v.constructor.name]);
  };
  return joinWith(".")(renderSelection(reverse(selectedAddresses)));
};
var render = function(st) {
  var addressText = selectedAddressText(st.pericope);
  return div2([class_("pericope")])([div2([class_("didascalia"), draggable2(true), onDragStart(DragStart.create), onDragLeave(DragLeave.create), onDragOver(DragOver.create), onDrop(Drop.create)])([function() {
    ...
    })])([text5("\u29C9")]), button([class_("didascalia-remove"), onClick(function(v) {
      return Remove.value;
    })])([text5("\u2715")])]), addressNode]);
  }(), function() {
    if (st.editingSource) {
      var sourceList = function() {
        ...
        if (st.sources instanceof Just) {
          ...
          var renderGroup = function(lang2) {
            ...
            var sorted = sortBy(comparing2(function($219) {
              return function(v) {
                return v.name;
              }(unwrap6($219));
            }))(entries);
          ...
          var languages2 = toUnfoldable5(fromFoldable6(mapFlipped3(st.sources.value0)(function($220) {
            return function(v) {
              return v.language;
            }(unwrap6($220));
          })));
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 161, column 28 - line 199, column 22): " + [st.sources.constructor.name]);
      }();
      return div2([class_("source editing"), onClick(SwallowDidascaliaClick.create)])(append5([input2([value14(st.pericope.source), onValueInput(SetSource.create), autofocus6(true), onKeyDown(function(ke) {
        var v = key(ke);
        if (v === "Enter") {
  ...
  }(), div2([class_("selected-address"), onClick(HandleSelectedAddressClick.create)])([text5(addressText)])]), div2([class_("textus")])(mapFlipped3(st.pericope.verses)(function(v) {
    ...
    var renderCrossRefs = function() {
      ...
      if (st.crossRefs instanceof CrossRefsLoaded) {
        var crossReferenceNodes = function() {
          var $102 = $$null(st.crossRefs.value0.references);
          if ($102) {
            return [div2([class_("cross-references-empty")])([])];
          }
          ;
        ...
        var commentaryNodes = function() {
          var $103 = $$null(st.crossRefs.value0.commentaries);
          if ($103) {
            return [];
          }
          ;
        ...
        return append5(crossReferenceNodes)(commentaryNodes);
      }
      ;
      throw new Error("Failed pattern match at Pericope (line 242, column 27 - line 271, column 53): " + [st.crossRefs.constructor.name]);
    }();
    return div2([class_("margin")])(renderCrossRefs);
  }()]);
};
      ...
      return bind7(liftAff3(fetchVerses(address2)(source2)))(function(res) {
        ...
        if (res instanceof Right) {
          return discard12(modify_3(function(st) {
            ...
            ;
            $110.pericope = function() {
              var $107 = {};
              for (var $108 in st.pericope) {
                if ({}.hasOwnProperty.call(st.pericope, $108)) {
                  $107[$108] = st["pericope"][$108];
                }
                ;
              }
              ;
              $107.verses = res.value0;
              $107.selected = empty4;
              return $107;
            }();
            $110.crossRefs = CrossRefsIdle.value;
            return $110;
          }))(function() {
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 487, column 3 - line 495, column 39): " + [res.constructor.name]);
      });
    };
  };
};
  ...
  return function(v) {
    ...
    if (v instanceof HandleAddressClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        return modify_3(function(st) {
          ...
          ;
          $115.editingAddress = true;
          $115.originalAddress = new Just(st.pericope.address);
          return $115;
        });
      });
    }
    ...
    if (v instanceof HandleSourceClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        return discard12(modify_3(function(st) {
          ...
          ;
          $119.editingSource = true;
          $119.originalSource = new Just(st.pericope.source);
          return $119;
        }))(function() {
              ...
              return bind7(liftAff3(fetchSources))(function(res) {
                ...
                if (res instanceof Right) {
                  return modify_3(function(v1) {
                    ...
                    ;
                    $129.sources = new Just(res.value0);
                    return $129;
                  });
                }
                ;
                throw new Error("Failed pattern match at Pericope (line 319, column 9 - line 321, column 60): " + [res.constructor.name]);
              });
            }
            ;
            throw new Error("Failed pattern match at Pericope (line 315, column 5 - line 321, column 60): " + [st.sources.constructor.name]);
          });
        });
      });
    }
    ...
    if (v instanceof SetAddress) {
      return modify_3(function(st) {
        ...
        ;
        $139.pericope = function() {
          var $136 = {};
          for (var $137 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $137)) {
              $136[$137] = st["pericope"][$137];
            }
            ;
          }
          ;
          $136.address = v.value0;
          return $136;
        }();
        return $139;
      });
    ...
    if (v instanceof SetSource) {
      return modify_3(function(st) {
        ...
        ;
        $146.pericope = function() {
          var $143 = {};
          for (var $144 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $144)) {
              $143[$144] = st["pericope"][$144];
            }
            ;
          }
          ;
    ...
    if (v instanceof SubmitAddress) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $150.editingAddress = false;
          $150.originalAddress = Nothing.value;
          return $150;
        }))(function() {
    ...
    if (v instanceof SubmitSource) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $156.editingSource = false;
          $156.originalSource = Nothing.value;
          return $156;
        }))(function() {
          return launchFetch1(st.pericope.address)(st.pericope.source);
        });
    ...
    if (v instanceof CancelAddressEdit) {
      return modify_3(function(st) {
        if (st.originalAddress instanceof Just) {
          ...
          ;
          $163.editingAddress = false;
          $163.originalAddress = Nothing.value;
          $163.pericope = function() {
            var $160 = {};
            for (var $161 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $161)) {
                $160[$161] = st["pericope"][$161];
              }
              ;
            }
            ;
            $160.address = st.originalAddress.value0;
            return $160;
          }();
          return $163;
        }
        ...
        if (st.originalAddress instanceof Nothing) {
          ...
          ;
          $167.editingAddress = false;
          $167.originalAddress = Nothing.value;
          return $167;
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 360, column 7 - line 371, column 14): " + [st.originalAddress.constructor.name]);
      });
    }
    ;
    if (v instanceof CancelSourceEdit) {
      return modify_3(function(st) {
        if (st.originalSource instanceof Just) {
          ...
          $174.pericope = function() {
            var $171 = {};
            for (var $172 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $172)) {
                $171[$172] = st["pericope"][$172];
              }
              ;
            }
            ;
            $171.source = st.originalSource.value0;
            return $171;
          }();
          return $174;
        }
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 375, column 7 - line 386, column 14): " + [st.originalSource.constructor.name]);
      });
    }
    ;
    ...
    if (v instanceof ToggleSelect) {
      return discard12(modify_3(function(st) {
        var sel1 = function() {
          var $188 = member3(v.value0)(st.pericope.selected);
          if ($188) {
        ...
        ;
        $193.pericope = function() {
          var $190 = {};
          for (var $191 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $191)) {
              $190[$191] = st["pericope"][$191];
            }
            ;
          }
          ;
        ...
        $193.crossRefs = nextCrossRefState;
        return $193;
      }))(function() {
        return bind7(get4)(function(st) {
                  ...
                  return bind7(stillSelected(selectedIds[0]))(function(stillAfterCommentaries) {
                    return when4(stillAfterCommentaries)(function() {
                      var refs = function() {
                        ...
                        ;
                        throw new Error("Failed pattern match at Pericope (line 426, column 24 - line 428, column 51): " + [refsRes.constructor.name]);
                      }();
                      var commentaries = function() {
                        ...
                        ;
                        throw new Error("Failed pattern match at Pericope (line 429, column 32 - line 431, column 67): " + [commRes.constructor.name]);
                      }();
                      return modify_3(function(v1) {
                        var $203 = {};
                        for (var $204 in v1) {
                        ...
                        ;
                        $203.crossRefs = new CrossRefsLoaded({
                          references: refs,
                          commentaries
                        });
                        return $203;
    ...
    if (v instanceof Receive2) {
      return modify_3(function(st) {
        ...
        var $214 = {};
        for (var $215 in st) {
          if ({}.hasOwnProperty.call(st, $215)) {
            $214[$215] = st[$215];
          }
          ;
        }
        ;
        $214.pericope = v.value0;
        $214.crossRefs = CrossRefsIdle.value;
        $214.editingSource = function() {
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 295, column 10 - line 482, column 76): " + [v.constructor.name]);
  };
};
...
var OpenHelp = /* @__PURE__ */ function() {
  function OpenHelp2() {
  }
  ;
  OpenHelp2.value = new OpenHelp2();
  return OpenHelp2;
}();
var CloseHelp = /* @__PURE__ */ function() {
  function CloseHelp2() {
  }
  ;
  CloseHelp2.value = new CloseHelp2();
  return CloseHelp2;
}();
var HandleHelpKey = /* @__PURE__ */ function() {
  function HandleHelpKey2(value0) {
    this.value0 = value0;
  }
  ;
  HandleHelpKey2.create = function(value0) {
    return new HandleHelpKey2(value0);
  };
  return HandleHelpKey2;
}();
...
var renderSearchResult = function(result) {
  ...
  })])([div2([class_("search-result-address")])([text5(details2.source + (" \u2013 " + details2.address))]), div2([class_("search-result-text")])([text5(details2.text)])]);
};
var renderSearchResults = function(st) {
  var $74 = !st.searchOpen || $$null(st.searchResults);
  if ($74) {
    return [];
  }
  ;
...
var renderSearchFeedback = function(st) {
  ...
  if (!st.searchLoading && st.searchError instanceof Nothing) {
    var $78 = st.searchPerformed && $$null(st.searchResults);
    if ($78) {
  ...
  ;
  throw new Error("Failed pattern match at Main (line 135, column 6 - line 144, column 14): " + [st.searchLoading.constructor.name, st.searchError.constructor.name]);
};
var renderSearchSection = function(st) {
  return div2([class_("search-section")])(append12([div2([class_("search-input-group")])([input2([attr2("type")("text"), placeholder3("Search verses"), value15(st.searchInput), onValueInput(UpdateSearchInput.create), onFocus(function(v) {
    ...
    return FocusSearchInput.value;
  }), onKeyDown(HandleSearchKey.create)]), button([attr2("type")("button"), onClick(function(v) {
    return SubmitSearch.value;
  })])([text5("Search")])])])(append12(renderSearchFeedback(st))(renderSearchResults(st))));
};
var renderHelpLink = function(isOpen) {
  var attrs = [class_("help-footer")];
  return div2(attrs)([a([href4("#help"), class_("help-link"), role("button"), attr2("aria-expanded")(function() {
    if (isOpen) {
      return "true";
    }
    ;
    ...
    return function(verses) {
      return bind8(get5)(function(st) {
        ...
        return discard6(put3(function() {
          ...
          ;
          $80.pericopes = snoc(st.pericopes)(pericope);
          $80.nextId = st.nextId + 1 | 0;
          return $80;
        }()))(function() {
          return syncUrl;
        });
...
var helpModalRef = "help-modal";
var renderHelpModal = function(v) {
  if (!v) {
    return [];
  }
  ;
  if (v) {
    return [div2([class_("help-modal-backdrop")])([div2([class_("help-modal"), id3("help-modal"), ref2(helpModalRef), tabIndex2(0), onKeyDown(HandleHelpKey.create)])([h3_([text5("How to use deepbible")]), dl_([dt_([text5("Click address \u21E8 type \u21E8 Enter")]), dd_([text5("change pericope address")]), dt_([text5("Click source name \u21E8 type \u21E8 Enter")]), dd_([text5("change pericope source")]), dt_([text5("Click source name \u21E8 select from list")]), dd_([text5("change pericope source")]), dt_([text5("Click \u29C9")]), dd_([text5("duplicate pericope")]), dt_([text5("Click \u2715 ")]), dd_([text5("delete pericope")]), dt_([text5("Drag with \u2630")]), dd_([text5("reorder pericopes")]), dt_([text5("Click verse")]), dd_([text5("highlight verse")]), dt_([text5("With one verse highlighted \u21E8 click address (right margin)")]), dd_([text5("add verse as new pericope")]), dt_([text5("With any verse highlighted \u21E8 click selection address (left margin)")]), dd_([text5("add verse(s) as new pericope")])]), button([class_("help-close"), onClick(function(v1) {
      return CloseHelp.value;
    })])([text5("Close")])])])];
  }
  ;
  throw new Error("Failed pattern match at Main (line 195, column 1 - line 195, column 76): " + [v.constructor.name]);
};
var render2 = function(st) {
  return div_(append12([renderSearchSection(st), div_(map28(renderPericope)(st.pericopes)), renderHelpLink(st.helpOpen)])(renderHelpModal(st.helpOpen)));
};
var handle2 = function(action2) {
  if (action2 instanceof Initialize2) {
    return bind8(liftEffect7(loadSeeds))(function(urlSeeds) {
      ...
      return for_1(seeds)(function(v2) {
        return bind8(liftAff2(fetchVerses(v2.address)(v2.source)))(function(res) {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 250, column 7 - line 252, column 61): " + [res.constructor.name]);
        });
      });
    });
  }
  ...
  if (action2 instanceof SubmitSearch) {
    return bind8(get5)(function(st) {
      var query2 = trim(st.searchInput);
      var $99 = query2 === "";
      if ($99) {
        return pure15(unit);
      }
      ...
      return discard6(modify_4(function(st1) {
        var $100 = {};
        for (var $101 in st1) {
          if ({}.hasOwnProperty.call(st1, $101)) {
            $100[$101] = st1[$101];
          }
          ;
        }
        ;
        $100.searchInput = query2;
        $100.searchLoading = true;
        $100.searchError = Nothing.value;
        $100.searchOpen = true;
        $100.searchPerformed = true;
        $100.searchResults = [];
        return $100;
      }))(function() {
        return bind8(liftAff2(searchVerses(query2)))(function(res) {
  ...
  if (action2 instanceof ReceiveSearchResults) {
    if (action2.value0 instanceof Left) {
      return modify_4(function(st) {
        ...
        ;
        $104.searchLoading = false;
        $104.searchError = new Just(action2.value0.value0);
        $104.searchResults = [];
        return $104;
      });
    }
    ...
    if (action2.value0 instanceof Right) {
      return modify_4(function(st) {
        ...
        $108.searchResults = action2.value0.value0;
        $108.searchOpen = true;
        return $108;
      });
    }
    ;
    throw new Error("Failed pattern match at Main (line 277, column 31 - line 290, column 10): " + [action2.value0.constructor.name]);
  }
  ;
  if (action2 instanceof SelectSearchResult) {
    ...
    return discard6(modify_4(function(st) {
      ...
      return bind8(liftAff2(fetchVerses(details2.address)(details2.source)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 296, column 5 - line 298, column 75): " + [res.constructor.name]);
      });
    });
  }
  ;
  if (action2 instanceof FocusSearchInput) {
    return modify_4(function(st) {
      var $122 = st.searchPerformed || (st.searchLoading || function() {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 302, column 53 - line 304, column 29): " + [st.searchError.constructor.name]);
      }());
      if ($122) {
        var $123 = {};
        for (var $124 in st) {
  ...
  if (action2 instanceof StartDrag) {
    return modify_4(function(st) {
      ...
      ;
      $131.dragging = new Just(action2.value0);
      return $131;
    });
  }
  ;
  if (action2 instanceof OverDrag) {
    return modify_4(function(st) {
      ...
      ;
      $135.droppingOver = new Just(action2.value0);
      return $135;
    });
  }
  ;
  if (action2 instanceof LeaveDrag) {
    return modify_4(function(st) {
      ...
      ;
      $139.droppingOver = Nothing.value;
      return $139;
    });
  }
  ;
    ...
    return bind8(get5)(function(st) {
      ...
      if (st.dragging instanceof Just) {
        ...
        return discard6(put3(function() {
          ...
          ;
          $144.pericopes = ps;
          $144.dragging = Nothing.value;
          $144.droppingOver = Nothing.value;
          return $144;
        }()))(function() {
          return syncUrl;
        });
      ...
      ;
      throw new Error("Failed pattern match at Main (line 328, column 5 - line 333, column 16): " + [st.dragging.constructor.name]);
    });
  }
  ;
  if (action2 instanceof OpenHelp) {
    return discard6(modify_4(function(st) {
      var $149 = {};
      for (var $150 in st) {
      ...
      return bind8(getHTMLElementRef(helpModalRef))(function(mEl) {
        return for_22(mEl)(function($192) {
          return liftEffect7(focus($192));
        });
      });
    });
  }
  ;
  if (action2 instanceof CloseHelp) {
    return modify_4(function(st) {
      var $152 = {};
      for (var $153 in st) {
  ...
  ;
  if (action2 instanceof HandleHelpKey) {
    return when5(key(action2.value0) === "Escape")(handle2(CloseHelp.value));
  }
  ;
  if (action2 instanceof ChildMsg) {
      ...
      return bind8(get5)(function(st) {
        ...
        if (v2 instanceof Just) {
          return bind8(liftAff2(fetchVerses(v2.value0.address)(v2.value0.source)))(function(res) {
            ...
            ;
            throw new Error("Failed pattern match at Main (line 355, column 11 - line 357, column 51): " + [res.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Main (line 349, column 7 - line 357, column 51): " + [v2.constructor.name]);
      });
    }
    ;
    if (action2.value1 instanceof DidRemove) {
      return discard6(modify_4(function(st) {
        var $164 = length(st.pericopes) > 1;
        if ($164) {
          var $165 = {};
          for (var $166 in st) {
          ...
          ;
          $165.pericopes = filter(function(q2) {
    ...
    if (action2.value1 instanceof DidUpdate) {
      return discard6(modify_4(function(st) {
        ...
        ;
        $174.pericopes = mapFlipped4(st.pericopes)(function(q2) {
          var $173 = q2.id === action2.value1.value0.id;
          if ($173) {
    ...
    ;
    throw new Error("Failed pattern match at Main (line 346, column 23 - line 394, column 61): " + [action2.value1.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Main (line 239, column 17 - line 394, column 61): " + [action2.constructor.name]);
};
