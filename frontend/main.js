  ...
  return function(tag) {
    return function(value17) {
      if (tagOf(value17) === tag) {
        return pure18(unsafeFromForeign(value17));
      }
      ;
      if (otherwise) {
...
var unsafeReadProp = function(dictMonad) {
  ...
  return function(k) {
    return function(value17) {
      return unsafeReadPropImpl(fail3(new TypeMismatch("object", typeOf(value17))), pure18, k, value17);
    };
  };
};
  ...
  decodeJson: function(j) {
    return bind6(decodeJson2(j))(function(obj) {
      return bind6(getField3(obj)("name"))(function(name16) {
        return bind6(getField3(obj)("description_short"))(function(description_short) {
          return bind6(getField3(obj)("language"))(function(language2) {
            return pure10({
              name: name16,
              description_short,
...
var decodeJson6 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeRecord(/* @__PURE__ */ gDecodeJsonCons(/* @__PURE__ */ decodeFieldId(decodeJsonString))(gDecodeJsonNil)({
  reflectSymbol: function() {
    return "status";
  }
})()())());
var decodeJson7 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeAiSearchResult));
var decodeJson8 = /* @__PURE__ */ decodeJson(decodeAiSearchResponse);
...
var fetchCommentaries = function(verseId) {
  ...
  return bind7(post(driver)(json2)(url)(new Just(json(payload))))(function(res) {
    ...
    if (res instanceof Right) {
      ...
      if (v instanceof Left) {
        return pure11(new Left("Failed to fetch commentaries: " + verseId));
      }
      ;
      if (v instanceof Right) {
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 70, column 19 - line 72, column 54): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 68, column 3 - line 72, column 54): " + [res.constructor.name]);
  });
};
var fetchCrossReferences = function(verseId) {
  ...
  return bind7(post(driver)(json2)(url)(new Just(json(payload))))(function(res) {
    ...
    if (res instanceof Right) {
      ...
      if (v instanceof Left) {
        return pure11(new Left("Failed to fetch cross references: " + verseId));
      }
      ;
      if (v instanceof Right) {
        return pure11(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 58, column 19 - line 60, column 38): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 56, column 3 - line 60, column 38): " + [res.constructor.name]);
  });
};
  ...
  return function(address2) {
    ...
    return bind7(post(driver)(json2)(url)(new Just(json(payload))))(function(res) {
      ...
      if (res instanceof Right) {
        ...
        if (v instanceof Left) {
          return pure11(new Left("Failed to fetch stories: " + address2));
        }
        ;
        if (v instanceof Right) {
          return pure11(new Right(v.value0));
        ...
        ;
        throw new Error("Failed pattern match at Infrastructure.Api (line 82, column 19 - line 84, column 44): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 80, column 3 - line 84, column 44): " + [res.constructor.name]);
    });
  };
};
var fetchSources = /* @__PURE__ */ function() {
  var url = baseUrl + "/_all_sources";
  return bind7(get2(driver)(json2)(url))(function(res) {
    ...
    if (res instanceof Right) {
      ...
      if (v instanceof Left) {
        return pure11(new Left("Failed to fetch sources"));
      }
      ;
      if (v instanceof Right) {
        return pure11(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 46, column 19 - line 48, column 44): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 44, column 3 - line 48, column 44): " + [res.constructor.name]);
  });
}();
  ...
  return function(source2) {
    ...
    return bind7(post(driver)(json2)(url)(new Just(json(payload))))(function(res) {
      ...
      if (res instanceof Right) {
        ...
        if (v instanceof Left) {
          return pure11(new Left("Failed to fetch verses: " + address2));
        }
        ;
        if (v instanceof Right) {
          return pure11(new Right(v.value0));
...
var searchVerses = function(query3) {
  ...
  return bind7(post(driver)(json2)(url)(new Just(json(payload))))(function(res) {
    ...
    if (res instanceof Right) {
      ...
      if (v instanceof Left) {
        return pure11(new Left("Failed to search verses"));
      }
      ;
      if (v instanceof Right) {
        return pure11(new Right(v.value0));
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 94, column 19 - line 96, column 42): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 92, column 3 - line 96, column 42): " + [res.constructor.name]);
  });
};
...
var checkAiStatus = /* @__PURE__ */ function() {
  ...
  return bind7(post(driver)(json2)(aiStatusUrl)(new Just(json(payload))))(function(res) {
    ...
    ;
    throw new Error("Failed pattern match at Infrastructure.Api (line 123, column 3 - line 128, column 22): " + [res.constructor.name]);
  });
}();
...
var fetchAiExplanations = function(phrase) {
  return function(maybeSource) {
    var payload = function() {
      ...
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 102, column 7 - line 108, column 61): " + [maybeSource.constructor.name]);
    }();
    return bind7(post(driver)(json2)(aiExplainUrl)(new Just(json(payload))))(function(res) {
      ...
      if (res instanceof Right) {
        ...
        ;
        if (v instanceof Left) {
          var v1 = decodeJson8(res.value0.body);
          if (v1 instanceof Right) {
          ...
          ;
          throw new Error("Failed pattern match at Infrastructure.Api (line 114, column 17 - line 116, column 64): " + [v1.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Infrastructure.Api (line 112, column 19 - line 116, column 64): " + [v.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Infrastructure.Api (line 110, column 3 - line 116, column 64): " + [res.constructor.name]);
    });
  };
};
  ...
  return function(address2) {
    return function(source2) {
      return bind9(liftAff4(fetchVerses(address2)(source2)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 577, column 3 - line 585, column 39): " + [res.constructor.name]);
      });
    };
  };
};
var formatRange = function(start2) {
  return function(end) {
    ...
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 629, column 1 - line 629, column 36): " + [start2.constructor.name, end.constructor.name]);
  };
};
var renderRanges = function(arr) {
  var go2 = function(start2) {
    return function(prev) {
      return function(rest) {
        ...
        ;
        throw new Error("Failed pattern match at Pericope.Component (line 623, column 5 - line 627, column 67): " + [v2.constructor.name]);
      };
    };
  };
  var v = uncons(arr);
  ...
  ;
  throw new Error("Failed pattern match at Pericope.Component (line 618, column 3 - line 620, column 45): " + [v.constructor.name]);
};
...
var addressPrefix = function(address2) {
  ...
  ;
  throw new Error("Failed pattern match at Pericope.Component (line 612, column 3 - line 614, column 18): " + [v.constructor.name]);
};
var selectedAddressText = function(pericope) {
  ...
  var renderSelection = function(arr) {
    ...
    if (v instanceof Just) {
      ...
      ;
      throw new Error("Failed pattern match at Pericope.Component (line 603, column 11 - line 606, column 55): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Pericope.Component (line 595, column 7 - line 606, column 55): " + [v.constructor.name]);
  };
          ...
          return discard13(raise(new DidUpdate2(st.pericope)))(function() {
            ...
            if (selectedIds.length === 1) {
              var stillSelected = function(verse) {
                return bind9(get5)(function(st$prime) {
                  return pure15(size2(st$prime.pericope.selected) === 1 && member3(verse)(st$prime.pericope.selected));
                });
              };
                          ...
                          return bind9(stillSelected(selectedIds[0]))(function(stillAfterStories) {
                            return when4(stillAfterStories)(function() {
                              ...
                              var commentaries = function() {
                                ...
                                ;
                                throw new Error("Failed pattern match at Pericope.Component (line 484, column 38 - line 486, column 105): " + [commRes.constructor.name]);
                              }();
...
var render2 = function(st) {
  var addressText = selectedAddressText(st.pericope);
  return div2([class_("pericope"), onClick(HandlePericopeClick.create)])([div2([class_("didascalia"), draggable2(true), onDragStart(DragStart2.create), onDragLeave(DragLeave2.create), onDragOver(DragOver2.create), onDrop(Drop2.create)])([function() {
    ...
    if (st.editingSource) {
      var sourceList = function() {
        ...
        if (st.sources instanceof Just) {
          ...
          var languages2 = toUnfoldable5(fromFoldable6(mapFlipped4(filteredInfos)(function($276) {
            return function(v) {
              return v.language;
            }(unwrap6($276));
          })));
  ...
  }()]), div2([class_("textus")])(mapFlipped4(st.pericope.verses)(function(v) {
    ...
    var renderCrossRefs = function() {
      ...
      ;
      throw new Error("Failed pattern match at Pericope.Component (line 269, column 27 - line 303, column 67): " + [st.crossRefs.constructor.name]);
    }();
  ...
  return mkComponent({
    ...
    "eval": mkEval({
      ...
      receive: function($277) {
        return Just.create(Receive3.create($277));
      }
    })
  });
};
  ...
  return function(action2) {
    ...
    if (action2 instanceof SubmitSearch) {
      return bind10(get6)(function(st) {
        var defaultAiSource = map29(function(v2) {
          return v2.source;
...
var renderItem = function(index4) {
  return function(item) {
    if (item instanceof PericopeItem) {
      return [renderAddNoteButton(index4)("Add note above"), renderPericope(item.value0), renderAddNoteButton(index4 + 1 | 0)("Add note below")];
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at App.Main (line 110, column 25 - line 117, column 24): " + [item.constructor.name]);
  };
};
var render3 = function(st) {
  var items2 = concat(mapWithIndex2(renderItem)(st.items));
...
var itemId = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at App.Main (line 305, column 10 - line 307, column 21): " + [v.constructor.name]);
};
  ...
  function $tco_loop(action2) {
    ...
    var loadSeed = function(seed) {
      ...
      if ($90) {
        return bind11(liftAff3(fetchVerses(seed.address)(seed.source)))(function(res) {
          ...
          ;
          throw new Error("Failed pattern match at App.Main (line 297, column 9 - line 299, column 73): " + [res.constructor.name]);
        });
      }
      ;
      return pure17(unit);
    ...
    if (action2 instanceof StartDrag) {
      ...
      return modify_6(function(st) {
        ...
        ;
        $106.dragging = new Just(action2.value0);
        return $106;
      });
    }
    ;
    if (action2 instanceof OverDrag) {
      ...
      return modify_6(function(st) {
        ...
        ;
        $110.droppingOver = new Just(action2.value0);
        return $110;
      });
    }
    ;
    if (action2 instanceof LeaveDrag) {
      ...
      return modify_6(function(st) {
        ...
        ;
        $114.droppingOver = Nothing.value;
        return $114;
      });
    }
    ;
      ...
      return bind11(get7)(function(st) {
        ...
        if (st.dragging instanceof Just) {
          ...
          return discard8(put4(function() {
            ...
            ;
            $119.items = items2;
            $119.dragging = Nothing.value;
            $119.droppingOver = Nothing.value;
            return $119;
          }()))(function() {
            return syncUrl;
          });
        ...
        ;
        throw new Error("Failed pattern match at App.Main (line 189, column 5 - line 194, column 16): " + [st.dragging.constructor.name]);
      });
    }
    ;
      ...
      if (action2.value0 instanceof PericopeMsg) {
          ...
          return bind11(get7)(function(st) {
            ...
            if (v instanceof Just) {
              return bind11(liftAff3(fetchVerses(v.value0.address)(v.value0.source)))(function(res) {
                ...
                ;
                throw new Error("Failed pattern match at App.Main (line 206, column 13 - line 208, column 53): " + [res.constructor.name]);
              });
            }
            ;
            throw new Error("Failed pattern match at App.Main (line 200, column 9 - line 208, column 53): " + [v.constructor.name]);
          });
        }
        ;
        ...
        if (action2.value0.value1 instanceof DidUpdate2) {
          ...
          return discard8(modify_6(function(st) {
            ...
            ;
            $141.items = mapFlipped6(st.items)(updatePericope(action2.value0.value1.value0));
            return $141;
          }))(function() {
            return syncUrl;
          });
        ...
        if (action2.value0.value1 instanceof DidLoadCrossReference) {
          ...
          return bind11(liftAff3(fetchVerses(action2.value0.value1.value0.address)(action2.value0.value1.value0.source)))(function(res) {
            ...
            ;
            throw new Error("Failed pattern match at App.Main (line 233, column 9 - line 235, column 63): " + [res.constructor.name]);
          });
        }
        ;
        if (action2.value0.value1 instanceof DidCreatePericopeFromSelection) {
          ...
          return bind11(liftAff3(fetchVerses(action2.value0.value1.value0.address)(action2.value0.value1.value0.source)))(function(res) {
            ...
            ;
            throw new Error("Failed pattern match at App.Main (line 239, column 9 - line 241, column 63): " + [res.constructor.name]);
          });
        }
        ;
        if (action2.value0.value1 instanceof DidLoadStory) {
          ...
          return bind11(liftAff3(fetchVerses(action2.value0.value1.value0.address)(action2.value0.value1.value0.source)))(function(res) {
            ...
            ;
            throw new Error("Failed pattern match at App.Main (line 245, column 9 - line 247, column 63): " + [res.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at App.Main (line 197, column 28 - line 247, column 63): " + [action2.value0.value1.constructor.name]);
      }
      ;
      if (action2.value0 instanceof NoteMsg) {
        if (action2.value0.value1 instanceof DidDuplicate) {
          ...
          return bind11(get7)(function(st) {
            ...
            ;
            throw new Error("Failed pattern match at App.Main (line 252, column 9 - line 254, column 72): " + [v.constructor.name]);
          });
        }
        ;
        if (action2.value0.value1 instanceof DidRemove) {
          ...
          return discard8(modify_6(function(st) {
            ...
            ;
            $172.items = filter(function(item) {
              return itemId(item) !== action2.value0.value1.value0;
            })(st.items);
            return $172;
          }))(function() {
        ...
        if (action2.value0.value1 instanceof DidUpdate) {
          ...
          return discard8(modify_6(function(st) {
            ...
            ;
            $180.items = mapFlipped6(st.items)(updateNote(action2.value0.value1.value0));
            return $180;
          }))(function() {
            return syncUrl;
          });
        ...
        ;
        throw new Error("Failed pattern match at App.Main (line 249, column 24 - line 275, column 16): " + [action2.value0.value1.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at App.Main (line 196, column 19 - line 275, column 16): " + [action2.value0.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at App.Main (line 148, column 17 - line 275, column 16): " + [action2.constructor.name]);
  }
  ;
  while (!$tco_done) {
