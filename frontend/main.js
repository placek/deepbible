...
var decodeJson3 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeCrossReference));
var decodeJson1 = /* @__PURE__ */ decodeJson(/* @__PURE__ */ decodeArray2(decodeSourceInfo));
...
var selectedAddressText = function(pericope) {
  var selectedAddresses = catMaybes(mapFlipped3(pericope.verses)(function(v) {
    var $83 = member3(v.verse_id)(pericope.selected);
    if ($83) {
      return new Just(v);
    }
    ;
  ...
  var renderSelection = function(arr) {
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 461, column 7 - line 465, column 64): " + [v.constructor.name]);
  };
  return joinWith(".")(renderSelection(reverse(selectedAddresses)));
};
var render = function(st) {
  var addressText = selectedAddressText(st.pericope);
  return div2([class_("pericope")])([div2([class_("didascalia"), draggable2(true), onClick(function(v) {
    return Remove.value;
  }), onDragStart(DragStart.create), onDragLeave(DragLeave.create), onDragOver(DragOver.create), onDrop(Drop.create)])([function() {
    ...
    return div2([class_("didascalia-header")])([div2([class_("didascalia-handle")])([text5("\u2630")]), addressNode]);
  }(), function() {
    if (st.editingSource) {
      var sourceList = function() {
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 148, column 28 - line 186, column 22): " + [st.sources.constructor.name]);
      }();
    ...
    var renderCrossRefs = function() {
      ...
      if (st.crossRefs instanceof CrossRefsLoaded) {
        var $100 = $$null(st.crossRefs.value0);
        if ($100) {
          return [div2([class_("cross-references-empty")])([])];
        }
        ;
        return [ul([class_("cross-references")])(map26(renderRef)(st.crossRefs.value0))];
      }
      ;
      throw new Error("Failed pattern match at Pericope (line 229, column 27 - line 247, column 16): " + [st.crossRefs.constructor.name]);
    }();
  ...
  return function(address2) {
    return function(source2) {
      return bind7(liftAff3(fetchVerses(address2)(source2)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 443, column 3 - line 451, column 39): " + [res.constructor.name]);
      });
    };
  };
};
  ...
  return function(v) {
    ...
    if (v instanceof HandleAddressClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        ...
        return modify_3(function(st) {
          ...
          ;
          $113.editingAddress = true;
          $113.originalAddress = new Just(st.pericope.address);
          return $113;
        });
      });
    }
    ...
    if (v instanceof HandleSourceClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        ...
        return discard12(modify_3(function(st) {
          ...
          ;
          $118.editingSource = true;
          $118.originalSource = new Just(st.pericope.source);
          return $118;
        }))(function() {
          return bind7(get4)(function(st) {
            if (st.sources instanceof Just) {
              ...
              return bind7(liftAff3(fetchSources))(function(res) {
                ...
                if (res instanceof Right) {
                  return modify_3(function(v1) {
                    ...
                    ;
                    $128.sources = new Just(res.value0);
                    return $128;
                  });
                }
                ;
                throw new Error("Failed pattern match at Pericope (line 291, column 11 - line 293, column 62): " + [res.constructor.name]);
              });
            }
            ;
            throw new Error("Failed pattern match at Pericope (line 287, column 7 - line 293, column 62): " + [st.sources.constructor.name]);
          });
        });
      });
    }
    ...
    if (v instanceof SetAddress) {
      return modify_3(function(st) {
        ...
        ;
        $138.pericope = function() {
          var $135 = {};
          for (var $136 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $136)) {
              $135[$136] = st["pericope"][$136];
            }
            ;
          }
          ;
          $135.address = v.value0;
          return $135;
        }();
        return $138;
      });
    ...
    if (v instanceof SetSource) {
      return modify_3(function(st) {
        ...
        ;
        $145.pericope = function() {
          var $142 = {};
          for (var $143 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $143)) {
              $142[$143] = st["pericope"][$143];
            }
            ;
          }
          ;
    ...
    if (v instanceof SubmitAddress) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $149.editingAddress = false;
          $149.originalAddress = Nothing.value;
          return $149;
        }))(function() {
    ...
    if (v instanceof SubmitSource) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $155.editingSource = false;
          $155.originalSource = Nothing.value;
          return $155;
        }))(function() {
          return launchFetch1(st.pericope.address)(st.pericope.source);
        });
    ...
    if (v instanceof CancelAddressEdit) {
      return modify_3(function(st) {
        if (st.originalAddress instanceof Just) {
          ...
          ;
          $162.editingAddress = false;
          $162.originalAddress = Nothing.value;
          $162.pericope = function() {
            var $159 = {};
            for (var $160 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $160)) {
                $159[$160] = st["pericope"][$160];
              }
              ;
            }
            ;
            $159.address = st.originalAddress.value0;
            return $159;
          }();
          return $162;
        }
        ...
        if (st.originalAddress instanceof Nothing) {
          ...
          ;
          $166.editingAddress = false;
          $166.originalAddress = Nothing.value;
          return $166;
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 332, column 7 - line 343, column 14): " + [st.originalAddress.constructor.name]);
      });
    }
    ;
    if (v instanceof CancelSourceEdit) {
      return modify_3(function(st) {
        if (st.originalSource instanceof Just) {
          ...
          ;
          $173.editingSource = false;
          $173.originalSource = Nothing.value;
          $173.pericope = function() {
            ...
            ;
            $170.source = st.originalSource.value0;
            return $170;
          }();
          return $173;
        }
        ...
        if (st.originalSource instanceof Nothing) {
          ...
          ;
          $177.editingSource = false;
          $177.originalSource = Nothing.value;
          return $177;
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 347, column 7 - line 358, column 14): " + [st.originalSource.constructor.name]);
      });
    }
    ;
    if (v instanceof SelectSource) {
      return discard12(modify_3(function(st) {
        ...
        ;
        $183.pericope = function() {
          var $180 = {};
          for (var $181 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $181)) {
              $180[$181] = st["pericope"][$181];
            }
            ;
          }
          ;
    ...
    if (v instanceof ToggleSelect) {
      return discard12(modify_3(function(st) {
        var sel1 = function() {
          var $187 = member3(v.value0)(st.pericope.selected);
          if ($187) {
        ...
        $192.crossRefs = nextCrossRefState;
        return $192;
      }))(function() {
        return bind7(get4)(function(st) {
          var selectedIds = toUnfoldable5(st.pericope.selected);
          if (selectedIds.length === 1) {
            return bind7(liftAff3(fetchCrossReferences(selectedIds[0])))(function(res) {
              return bind7(get4)(function(st$prime) {
                var $196 = size3(st$prime.pericope.selected) === 1 && member3(selectedIds[0])(st$prime.pericope.selected);
                if ($196) {
                  if (res instanceof Left) {
                    return modify_3(function(v1) {
                      var $198 = {};
                      ...
                      ;
                      $198.crossRefs = new CrossRefsLoaded([]);
                      return $198;
                    });
                  }
                  ;
                  if (res instanceof Right) {
                    return modify_3(function(v1) {
                      ...
                      ;
                      $202.crossRefs = new CrossRefsLoaded(res.value0);
                      return $202;
                    });
                  }
                  ;
                  throw new Error("Failed pattern match at Pericope (line 390, column 13 - line 392, column 77): " + [res.constructor.name]);
                }
                ;
                return pure14(unit);
              });
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 259, column 10 - line 438, column 76): " + [v.constructor.name]);
  };
};
...
var renderHelpModal = function(v) {
  ...
  ;
  if (v) {
    return [div2([class_("help-modal-backdrop")])([div2([class_("help-modal"), id3("help-modal"), ref2(helpModalRef), tabIndex2(0), onKeyDown(HandleHelpKey.create)])([h3_([text5("How to use deepbible")]), ul_([li_([text5("Click address \u2192 type \u2192 Enter \u2013 change pericope address.")]), li_([text5("Click source name \u2192 type \u2192 Enter \u2013 change pericope source.")]), li_([text5("Click source name \u2192 select from list \u2013 change pericope source.")]), li_([text5("Ctrl + Click left margin \u2013 duplicate pericope.")]), li_([text5("Click left margin (not address/source) \u2013 delete pericope.")]), li_([text5("Drag left margin \u2013 reorder pericopes.")]), li_([text5("Click verse \u2013 highlight verse.")]), li_([text5("With one verse highlighted \u2192 click address (right margin) \u2013 add verse as new pericope.")])]), button([class_("help-close"), onClick(function(v1) {
