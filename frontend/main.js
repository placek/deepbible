...
var request = function(driver2) {
  return function(req) {
    ...
    var headers = function(reqContent) {
      return addHeader(map10(ContentType.create)(bindFlipped5(toMediaType)(reqContent)))(addHeader(map10(Accept.create)(toMediaType2(req.responseFormat)))(req.headers));
    };
...
var lastIndexOf2 = function(p2) {
  return function(s) {
    return map13(function(i2) {
      return length4(take2(i2)(s));
    })(lastIndexOf(p2)(s));
  };
};
...
// output/Query/foreign.js
var encodeURIComponent2 = (value16) => {
  return globalThis.encodeURIComponent(value16);
};
...
var decodeVerseSearchResult = {
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField3(obj)("address"))(function(address2) {
        return bind2(getField3(obj)("source"))(function(source2) {
          return bind2(getField3(obj)("text"))(function(text6) {
            return pure4({
              address: address2,
              source: source2,
              text: text6
...
var decodeVerse = {
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField1(obj)("book_number"))(function(book_number) {
        return bind2(getField1(obj)("chapter"))(function(chapter) {
          return bind2(getField1(obj)("verse"))(function(verse) {
            return bind2(getField3(obj)("verse_id"))(function(verse_id) {
              return bind2(getField3(obj)("language"))(function(language2) {
                return bind2(getField3(obj)("source"))(function(source2) {
                  return bind2(getField3(obj)("address"))(function(address2) {
                    return bind2(getField3(obj)("text"))(function(text6) {
                      return pure4({
  ...
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField3(obj)("name"))(function(name16) {
        return bind2(getField3(obj)("description_short"))(function(description_short) {
          return bind2(getField3(obj)("language"))(function(language2) {
            return pure4({
              name: name16,
              description_short,
...
var decodeCrossReference = {
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField3(obj)("id"))(function(id3) {
        return bind2(getField3(obj)("address"))(function(address2) {
          return bind2(getField3(obj)("reference"))(function(reference) {
            return bind2(getField1(obj)("rate"))(function(rate) {
              return pure4({
                id: id3,
                address: address2,
                reference,
...
var decodeCommentary = {
  decodeJson: function(j) {
    return bind2(decodeJson2(j))(function(obj) {
      return bind2(getField3(obj)("marker"))(function(marker) {
        return bind2(getField3(obj)("text"))(function(text6) {
          return pure4({
            marker,
            text: text6
...
var postLocalReferences = function(first) {
  return function(second) {
    var url = baseUrl + "/local_references";
    var payload = extend4(assoc3("first")(id(first)))(extend4(assoc3("second")(id(second)))(jsonEmptyObject));
    return bind3(post(driver)(ignore)(url)(new Just(json(payload))))(function(res) {
      if (res instanceof Left) {
        return pure5(new Left("HTTP error: " + printError(res.value0)));
      }
      ;
      if (res instanceof Right) {
        return pure5(new Right(unit));
      }
      ;
...
var selectElement = function(query3) {
  return bind4(liftEffect3(bindFlipped6(composeKleisliFlipped4(function() {
...
var evalQ = function(render3) {
  return function(ref2) {
    return function(q2) {
      return bind12(liftEffect4(read(ref2)))(function(v) {
        return evalM(render3)(ref2)(v["component"]["eval"](new Query(map22(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
      });
    };
  };
};
...
var runUI2 = function(component3) {
  return function(i2) {
    return function(element3) {
      return bind14(liftEffect6(map26(toDocument)(bindFlipped9(document)(windowImpl))))(function(document2) {
      ...
      return bind7(liftAff3(fetchVerses(address2)(source2)))(function(res) {
        ...
        if (res instanceof Right) {
          return discard12(modify_3(function(st) {
            ...
            ;
            $102.pericope = function() {
              var $99 = {};
              for (var $100 in st.pericope) {
                if ({}.hasOwnProperty.call(st.pericope, $100)) {
                  $99[$100] = st["pericope"][$100];
                }
                ;
              }
              ;
              $99.verses = res.value0;
              $99.selected = empty4;
              return $99;
            }();
            $102.crossRefs = CrossRefsIdle.value;
            return $102;
          }))(function() {
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 539, column 3 - line 547, column 39): " + [res.constructor.name]);
      });
    };
  };
};
var formatRange = function(start2) {
  return function(end) {
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 591, column 1 - line 591, column 36): " + [start2.constructor.name, end.constructor.name]);
  };
};
var renderRanges = function(arr) {
  var go2 = function(start2) {
    return function(prev) {
      return function(rest) {
        ...
        ;
        throw new Error("Failed pattern match at Pericope (line 585, column 5 - line 589, column 67): " + [v2.constructor.name]);
      };
    };
  };
  var v = uncons(arr);
  ...
  ;
  throw new Error("Failed pattern match at Pericope (line 580, column 3 - line 582, column 45): " + [v.constructor.name]);
};
var addressPrefix = function(address2) {
  ...
  ;
  throw new Error("Failed pattern match at Pericope (line 574, column 3 - line 576, column 18): " + [v.constructor.name]);
};
var selectedAddressText = function(pericope) {
  var selectedAddresses = catMaybes(mapFlipped3(pericope.verses)(function(v) {
    var $119 = member3(v.verse_id)(pericope.selected);
    if ($119) {
      return new Just(v);
    }
    ;
  ...
  var renderSelection = function(arr) {
    ...
    if (v instanceof Just) {
      ...
      ;
      throw new Error("Failed pattern match at Pericope (line 565, column 11 - line 568, column 55): " + [v1.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Pericope (line 557, column 7 - line 568, column 55): " + [v.constructor.name]);
  };
  ...
  return function(v) {
    ...
    if (v instanceof HandleAddressClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        return modify_3(function(st) {
          ...
          ;
          $130.editingAddress = true;
          $130.originalAddress = new Just(st.pericope.address);
          return $130;
        });
      });
    }
    ...
    if (v instanceof HandleSourceClick) {
      return discard12(liftEffect8(stopPropagation(toEvent2(v.value0))))(function() {
        return discard12(modify_3(function(st) {
          ...
          ;
          $134.editingSource = true;
          $134.originalSource = new Just(st.pericope.source);
          return $134;
        }))(function() {
              ...
              return bind7(liftAff3(fetchSources))(function(res) {
                ...
                if (res instanceof Right) {
                  return modify_3(function(v1) {
                    ...
                    ;
                    $144.sources = new Just(res.value0);
                    return $144;
                  });
                }
                ;
                throw new Error("Failed pattern match at Pericope (line 345, column 9 - line 347, column 60): " + [res.constructor.name]);
              });
            }
            ;
            throw new Error("Failed pattern match at Pericope (line 341, column 5 - line 347, column 60): " + [st.sources.constructor.name]);
          });
        });
      });
    }
    ...
    if (v instanceof SetAddress) {
      return modify_3(function(st) {
        ...
        ;
        $154.pericope = function() {
          var $151 = {};
          for (var $152 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $152)) {
              $151[$152] = st["pericope"][$152];
            }
            ;
          }
          ;
          $151.address = v.value0;
          return $151;
        }();
        return $154;
      });
    ...
    if (v instanceof SubmitAddress) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          ;
          $165.editingAddress = false;
          $165.originalAddress = Nothing.value;
          return $165;
        }))(function() {
    ...
    if (v instanceof SubmitSource) {
      return bind7(get4)(function(st) {
        return discard12(modify_3(function(v1) {
          ...
          $171.originalSource = Nothing.value;
          return $171;
        }))(function() {
          return launchFetch1(st.pericope.address)(st.pericope.source);
        });
    ...
    if (v instanceof CancelAddressEdit) {
      return modify_3(function(st) {
        if (st.originalAddress instanceof Just) {
          ...
          ;
          $178.editingAddress = false;
          $178.originalAddress = Nothing.value;
          $178.pericope = function() {
            var $175 = {};
            for (var $176 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $176)) {
                $175[$176] = st["pericope"][$176];
              }
              ;
            }
            ;
            $175.address = st.originalAddress.value0;
            return $175;
          }();
          return $178;
        }
        ...
        if (st.originalAddress instanceof Nothing) {
          ...
          ;
          $182.editingAddress = false;
          $182.originalAddress = Nothing.value;
          return $182;
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 386, column 7 - line 397, column 14): " + [st.originalAddress.constructor.name]);
      });
    }
    ;
    if (v instanceof CancelSourceEdit) {
      return modify_3(function(st) {
        if (st.originalSource instanceof Just) {
          ...
          $189.pericope = function() {
            var $186 = {};
            for (var $187 in st.pericope) {
              if ({}.hasOwnProperty.call(st.pericope, $187)) {
                $186[$187] = st["pericope"][$187];
              }
              ;
            }
            ;
            $186.source = st.originalSource.value0;
            return $186;
          }();
          return $189;
        }
        ...
        if (st.originalSource instanceof Nothing) {
          var $193 = {};
          for (var $194 in st) {
            if ({}.hasOwnProperty.call(st, $194)) {
              $193[$194] = st[$194];
            }
            ;
          }
          ;
          $193.editingSource = false;
          $193.originalSource = Nothing.value;
          return $193;
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 401, column 7 - line 412, column 14): " + [st.originalSource.constructor.name]);
      });
    }
    ;
    if (v instanceof SelectSource) {
      return discard12(modify_3(function(st) {
        ...
        ;
        $199.pericope = function() {
          var $196 = {};
          for (var $197 in st.pericope) {
            if ({}.hasOwnProperty.call(st.pericope, $197)) {
              $196[$197] = st["pericope"][$197];
            }
            ;
          }
          ;
        ...
        $199.editingSource = false;
        $199.originalSource = Nothing.value;
        return $199;
      }))(function() {
        return bind7(get4)(function(st) {
    ...
    if (v instanceof ToggleSelect) {
      return discard12(modify_3(function(st) {
        var sel1 = function() {
          var $203 = member3(v.value0)(st.pericope.selected);
          if ($203) {
        ...
        $208.crossRefs = nextCrossRefState;
        return $208;
      }))(function() {
        return bind7(get4)(function(st) {
          return discard12(raise(new DidUpdate(st.pericope)))(function() {
            ...
            if (selectedIds.length === 1) {
              var stillSelected = function(verse) {
                return bind7(get4)(function(st$prime) {
                  return pure14(size3(st$prime.pericope.selected) === 1 && member3(verse)(st$prime.pericope.selected));
                });
              };
                ...
                return bind7(stillSelected(selectedIds[0]))(function(stillAfterRefs) {
                  return when4(stillAfterRefs)(bind7(liftAff3(fetchCommentaries(selectedIds[0])))(function(commRes) {
                    return bind7(stillSelected(selectedIds[0]))(function(stillAfterCommentaries) {
                      return when4(stillAfterCommentaries)(function() {
                        var refs = function() {
                          ...
                          ;
                          throw new Error("Failed pattern match at Pericope (line 453, column 24 - line 455, column 51): " + [refsRes.constructor.name]);
                        }();
                        var commentaries = function() {
                          ...
                          ;
                          throw new Error("Failed pattern match at Pericope (line 456, column 32 - line 458, column 67): " + [commRes.constructor.name]);
                        }();
                        return modify_3(function(v1) {
                          var $218 = {};
                          for (var $219 in v1) {
                          ...
                          ;
                          $218.crossRefs = new CrossRefsLoaded({
                            references: refs,
                            commentaries
                          });
                          return $218;
    ...
    if (v instanceof Receive2) {
      return modify_3(function(st) {
        ...
        ;
        $229.pericope = v.value0;
        $229.crossRefs = CrossRefsIdle.value;
        $229.editingSource = function() {
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 318, column 10 - line 509, column 76): " + [v.constructor.name]);
  };
};
...
var handleQuery = function(dictMonadAff) {
  ...
  return function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Pericope (line 516, column 15 - line 526, column 18): " + [v.constructor.name]);
  };
};
  ...
  return div2([class_("pericope"), onClick(HandlePericopeClick.create)])([div2([class_("didascalia"), draggable2(true), onDragStart(DragStart.create), onDragLeave(DragLeave.create), onDragOver(DragOver.create), onDrop(Drop.create)])([function() {
    ...
    if (st.editingSource) {
      var sourceList = function() {
        ...
        ;
        if (st.sources instanceof Just) {
          var $246 = $$null(st.sources.value0);
          if ($246) {
          ...
          var renderGroup = function(lang2) {
            ...
            var sorted = sortBy(comparing2(function($259) {
              return function(v) {
                return v.name;
              }(unwrap6($259));
            }))(entries);
          ...
          return [div2([class_("source-list")])(map27(renderGroup)(sortedLanguages))];
        }
        ;
        throw new Error("Failed pattern match at Pericope (line 165, column 28 - line 219, column 24): " + [st.sources.constructor.name]);
      }();
    ...
    var renderCommentary = function(v) {
      return li([class_("commentary")])([span4([class_("commentary-marker")])([text5(v.marker)]), span4([class_("commentary-text"), prop3("innerHTML")(v.text)])([])]);
    };
    var renderCrossRefs = function() {
      ...
      if (st.crossRefs instanceof CrossRefsLoaded) {
        var crossReferenceNodes = function() {
          var $256 = $$null(st.crossRefs.value0.references);
          if ($256) {
            return [div2([class_("cross-references-empty")])([])];
          }
          ;
      ...
      ;
      throw new Error("Failed pattern match at Pericope (line 265, column 27 - line 294, column 53): " + [st.crossRefs.constructor.name]);
    }();
...
var component = function(dictMonadAff) {
  return mkComponent({
    ...
    "eval": mkEval({
      ...
      receive: function($261) {
        return Just.create(Receive2.create($261));
      }
    })
  });
};
...
var SelectionRibbonClick = /* @__PURE__ */ function() {
  function SelectionRibbonClick2(value0) {
    this.value0 = value0;
  }
  ;
  SelectionRibbonClick2.create = function(value0) {
    return new SelectionRibbonClick2(value0);
  };
  return SelectionRibbonClick2;
}();
...
var stripTags = /* @__PURE__ */ function() {
  var go2 = function(insideTag) {
    return function(chars) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 217, column 5 - line 223, column 50): " + [v.constructor.name]);
    };
  };
  var $219 = go2(false);
  return function($220) {
    return fromCharArray($219(toCharArray($220)));
  };
}();
...
var renderSearchFeedback = function(st) {
  ...
  if (!st.searchLoading && st.searchError instanceof Nothing) {
    var $90 = st.searchPerformed && $$null(st.searchResults);
    if ($90) {
  ...
  ;
  throw new Error("Failed pattern match at Main (line 172, column 6 - line 181, column 14): " + [st.searchLoading.constructor.name, st.searchError.constructor.name]);
};
var renderSearchSection = function(st) {
  return div2([class_("search-section")])(append13([div2([class_("search-input-group")])([input2([attr2("type")("text"), placeholder3("Search verses"), value15(st.searchInput), onValueInput(UpdateSearchInput.create), onFocus(function(v) {
    ...
    return function(verses) {
      return bind8(get5)(function(st) {
        ...
        return discard6(put3(function() {
          ...
          ;
          $91.pericopes = snoc(st.pericopes)(pericope);
...
var expandSelectionAddress = function(addressText) {
  var segments = filter(function(v2) {
    return v2 !== "";
  })(map29(trim)(split(".")(addressText)));
  var applyPrefix = function(v2) {
    return function(v1) {
      if (v2 instanceof Nothing) {
        return v1;
      }
      ...
      ;
      throw new Error("Failed pattern match at Main (line 486, column 5 - line 486, column 52): " + [v2.constructor.name, v1.constructor.name]);
    };
  };
  var addressPrefixFromString = function(segment) {
    return bind15(lastIndexOf2(",")(segment))(function(ix) {
      return pure15(take2(ix + 1 | 0)(segment));
    });
  };
  var v = uncons(segments);
  if (v instanceof Nothing) {
    return [];
  }
  ;
  if (v instanceof Just) {
    var prefix = addressPrefixFromString(v.value0.head);
    var restWithPrefix = mapFlipped4(v.value0.tail)(applyPrefix(prefix));
    return cons(v.value0.head)(restWithPrefix);
  }
  ;
  throw new Error("Failed pattern match at Main (line 473, column 3 - line 479, column 40): " + [v.constructor.name]);
};
var selectedPericopeAddresses = function(pericopes) {
  var selectionFromPericope = function(p2) {
    var text6 = selectedAddressText(p2);
    return {
      text: text6,
      groups: expandSelectionAddress(text6)
    };
  };
  var pericopesWithSelection = mapFlipped4(filter(function(p2) {
    return size3(p2.selected) > 0;
  })(pericopes))(selectionFromPericope);
  if (pericopesWithSelection.length === 2) {
    return new Just({
      first: pericopesWithSelection[0],
      second: pericopesWithSelection[1]
    });
  }
  ;
  return Nothing.value;
...
var handle2 = function(action2) {
    ...
    return bind8(liftEffect7(loadSeeds))(function(urlSeeds) {
      ...
      return for_3(seeds)(function(v2) {
        return bind8(liftAff2(fetchVerses(v2.address)(v2.source)))(function(res) {
          ...
          ;
          throw new Error("Failed pattern match at Main (line 253, column 7 - line 255, column 61): " + [res.constructor.name]);
        });
      });
    });
  }
  ...
  if (action2 instanceof UpdateSearchInput) {
    return modify_4(function(st) {
      ...
      ;
      $116.searchInput = action2.value0;
      return $116;
    });
  }
  ;
  if (action2 instanceof SubmitSearch) {
    return bind8(get5)(function(st) {
      ...
      return discard6(modify_4(function(state3) {
        ...
        ;
        $121.searchInput = query1;
        $121.searchLoading = true;
        $121.searchError = Nothing.value;
        $121.searchOpen = true;
        $121.searchPerformed = true;
        $121.searchResults = [];
        return $121;
      }))(function() {
  ...
  if (action2 instanceof ReceiveSearchResults) {
    if (action2.value0 instanceof Left) {
      return modify_4(function(st) {
        ...
        ;
        $125.searchLoading = false;
        $125.searchError = new Just(action2.value0.value0);
        $125.searchResults = [];
        return $125;
      });
    }
    ...
    if (action2.value0 instanceof Right) {
      return modify_4(function(st) {
        ...
        ;
        $129.searchLoading = false;
        $129.searchError = Nothing.value;
        $129.searchResults = action2.value0.value0;
        $129.searchOpen = true;
        return $129;
      });
    }
    ;
    throw new Error("Failed pattern match at Main (line 280, column 31 - line 293, column 10): " + [action2.value0.constructor.name]);
  }
  ;
  if (action2 instanceof SelectSearchResult) {
    ...
    return discard6(modify_4(function(st) {
      ...
      return bind8(liftAff2(fetchVerses(details2.address)(details2.source)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 299, column 5 - line 301, column 75): " + [res.constructor.name]);
      });
    });
  }
  ;
  if (action2 instanceof FocusSearchInput) {
    return modify_4(function(st) {
      var $143 = st.searchPerformed || (st.searchLoading || function() {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 305, column 53 - line 307, column 29): " + [st.searchError.constructor.name]);
      }());
      if ($143) {
        var $144 = {};
        for (var $145 in st) {
  ...
  ;
  if (action2 instanceof SelectionRibbonClick) {
    return discard6(liftEffect7(stopPropagation(toEvent2(action2.value0))))(function() {
      return bind8(get5)(function(st) {
        var v2 = selectedPericopeAddresses(st.pericopes);
        if (v2 instanceof Nothing) {
          return pure16(unit);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Main (line 335, column 5 - line 338, column 70): " + [v2.constructor.name]);
      });
    });
  }
  ;
  if (action2 instanceof StartDrag) {
    return modify_4(function(st) {
      ...
      ;
      $162.dragging = new Just(action2.value0);
      return $162;
    });
  }
  ;
  if (action2 instanceof OverDrag) {
    return modify_4(function(st) {
      ...
      ;
      $166.droppingOver = new Just(action2.value0);
      return $166;
    });
  }
  ;
  if (action2 instanceof LeaveDrag) {
    return modify_4(function(st) {
      ...
      ;
      $170.droppingOver = Nothing.value;
      return $170;
    });
  }
  ;
    ...
    return bind8(get5)(function(st) {
      ...
      if (st.dragging instanceof Just) {
        ...
        return discard6(put3(function() {
          ...
          ;
          $175.pericopes = ps;
          $175.dragging = Nothing.value;
          $175.droppingOver = Nothing.value;
          return $175;
        }()))(function() {
          return syncUrl;
        });
      ...
      ;
      throw new Error("Failed pattern match at Main (line 351, column 5 - line 356, column 16): " + [st.dragging.constructor.name]);
    });
  }
  ;
  if (action2 instanceof ChildMsg) {
      ...
      return bind8(get5)(function(st) {
        ...
        if (v2 instanceof Just) {
          return bind8(liftAff2(fetchVerses(v2.value0.address)(v2.value0.source)))(function(res) {
            ...
            ;
            throw new Error("Failed pattern match at Main (line 367, column 11 - line 369, column 51): " + [res.constructor.name]);
          });
        }
        ;
        throw new Error("Failed pattern match at Main (line 361, column 7 - line 369, column 51): " + [v2.constructor.name]);
      });
    }
    ;
    if (action2.value1 instanceof DidRemove) {
      return discard6(modify_4(function(st) {
        var $188 = length(st.pericopes) > 1;
        if ($188) {
          var $189 = {};
          for (var $190 in st) {
            if ({}.hasOwnProperty.call(st, $190)) {
          ...
          ;
          $189.pericopes = filter(function(q2) {
    ...
    if (action2.value1 instanceof DidUpdate) {
      return discard6(modify_4(function(st) {
        ...
        ;
        $198.pericopes = mapFlipped4(st.pericopes)(function(q2) {
          var $197 = q2.id === action2.value1.value0.id;
          if ($197) {
    ...
    if (action2.value1 instanceof DidLoadCrossReference) {
      return bind8(liftAff2(fetchVerses(action2.value1.value0.address)(action2.value1.value0.source)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 398, column 7 - line 400, column 61): " + [res.constructor.name]);
      });
    }
    ;
    if (action2.value1 instanceof DidCreatePericopeFromSelection) {
      return bind8(liftAff2(fetchVerses(action2.value1.value0.address)(action2.value1.value0.source)))(function(res) {
        ...
        ;
        throw new Error("Failed pattern match at Main (line 404, column 7 - line 406, column 61): " + [res.constructor.name]);
      });
    }
    ;
    throw new Error("Failed pattern match at Main (line 358, column 23 - line 406, column 61): " + [action2.value1.constructor.name]);
  }
  ;
  throw new Error("Failed pattern match at Main (line 242, column 17 - line 406, column 61): " + [action2.constructor.name]);
};
var renderSelectionRibbon = function(st) {
  var renderSelectionColumn = function(groups) {
    return ul([class_("selection-ribbon-column")])(function() {
      ...
      ;
      return mapFlipped4(groups)(function(entry) {
        return li([class_("selection-ribbon-address")])([text5(entry)]);
      });
    }());
  };
  var v = selectedPericopeAddresses(st.pericopes);
  if (v instanceof Just) {
    return [div2([class_("selection-ribbon"), onClick(SelectionRibbonClick.create)])([div2([class_("selection-ribbon-addresses")])([renderSelectionColumn(v.value0.first.groups), div2([class_("selection-ribbon-plus")])([text5("+")]), renderSelectionColumn(v.value0.second.groups)])])];
  }
  ;
  if (v instanceof Nothing) {
    return [];
  ...
  ;
  throw new Error("Failed pattern match at Main (line 114, column 3 - line 129, column 9): " + [v.constructor.name]);
};
var render2 = function(st) {
  return div2([onClick(function(v) {
    return HandleDocumentClick.value;
  })])(append13(renderSelectionRibbon(st))([renderSearchSection(st), div_(map29(renderPericope)(st.pericopes)), renderFooter]));
};
